...
#### 7.5 Taskbar 中 applet 的位置


1.首先 m_task_button_container 会占一定空间将 applet的x  通过 BoxLayout::run(Widget& widget) 、item.widget->set_relative_rect(rect); 设置为 718
...
// 先计算各个widget的最小大小，然后计算合适大小，最后计算位置
