...
#include <LibWeb/Bindings/ShadowRootWrapper.h>
...
#if __has_include(<LibWeb/Crypto/ShadowRoot.h>)
#    include <LibWeb/Crypto/ShadowRoot.h>
#elif __has_include(<LibWeb/CSS/ShadowRoot.h>)
#    include <LibWeb/CSS/ShadowRoot.h>
#elif __has_include(<LibWeb/DOM/ShadowRoot.h>)
#    include <LibWeb/DOM/ShadowRoot.h>
#elif __has_include(<LibWeb/Encoding/ShadowRoot.h>)
#    include <LibWeb/Encoding/ShadowRoot.h>
#elif __has_include(<LibWeb/Geometry/ShadowRoot.h>)
#    include <LibWeb/Geometry/ShadowRoot.h>
#elif __has_include(<LibWeb/HTML/ShadowRoot.h>)
#    include <LibWeb/HTML/ShadowRoot.h>
#elif __has_include(<LibWeb/UIEvents/ShadowRoot.h>)
#    include <LibWeb/UIEvents/ShadowRoot.h>
#elif __has_include(<LibWeb/HighResolutionTime/ShadowRoot.h>)
#    include <LibWeb/HighResolutionTime/ShadowRoot.h>
#elif __has_include(<LibWeb/IntersectionObserver/ShadowRoot.h>)
#    include <LibWeb/IntersectionObserver/ShadowRoot.h>
#elif __has_include(<LibWeb/NavigationTiming/ShadowRoot.h>)
#    include <LibWeb/NavigationTiming/ShadowRoot.h>
#elif __has_include(<LibWeb/RequestIdleCallback/ShadowRoot.h>)
#    include <LibWeb/RequestIdleCallback/ShadowRoot.h>
#elif __has_include(<LibWeb/ResizeObserver/ShadowRoot.h>)
#    include <LibWeb/ResizeObserver/ShadowRoot.h>
#elif __has_include(<LibWeb/SVG/ShadowRoot.h>)
#    include <LibWeb/SVG/ShadowRoot.h>
#elif __has_include(<LibWeb/Selection/ShadowRoot.h>)
#    include <LibWeb/Selection/ShadowRoot.h>
#elif __has_include(<LibWeb/WebSockets/ShadowRoot.h>)
#    include <LibWeb/WebSockets/ShadowRoot.h>
#elif __has_include(<LibWeb/XHR/ShadowRoot.h>)
#    include <LibWeb/XHR/ShadowRoot.h>
#elif __has_include(<LibWeb/URL/ShadowRoot.h>)
#    include <LibWeb/URL/ShadowRoot.h>
#endif
...
#if __has_include(<LibWeb/Bindings/ShadowRootWrapper.h>)
#   include <LibWeb/Bindings/ShadowRootWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/ShadowRootWrapperFactory.h>)
#   include <LibWeb/Bindings/ShadowRootWrapperFactory.h>
#endif
...
ShadowRootConstructor::ShadowRootConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

ShadowRootConstructor::~ShadowRootConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> ShadowRootConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "ShadowRoot");
}

JS::ThrowCompletionOr<JS::Object*> ShadowRootConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "ShadowRoot");

}

void ShadowRootConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<ShadowRootPrototype>("ShadowRoot"), 0);
