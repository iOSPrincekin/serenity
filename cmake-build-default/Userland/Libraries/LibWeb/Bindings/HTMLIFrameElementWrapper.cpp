...
HTMLIFrameElementWrapper* HTMLIFrameElementWrapper::create(JS::GlobalObject& global_object, HTML::HTMLIFrameElement& impl)
{
    return global_object.heap().allocate<HTMLIFrameElementWrapper>(global_object, global_object, impl);
}


HTMLIFrameElementWrapper::HTMLIFrameElementWrapper(JS::GlobalObject& global_object, HTML::HTMLIFrameElement& impl)
    : HTMLElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLIFrameElementPrototype>("HTMLIFrameElement"));
}

void HTMLIFrameElementWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLIFrameElement"), JS::Attribute::Configurable);
}

HTMLIFrameElementWrapper::~HTMLIFrameElementWrapper()
{
}
