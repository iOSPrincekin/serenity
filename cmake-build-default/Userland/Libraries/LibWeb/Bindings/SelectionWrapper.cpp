...
SelectionWrapper* SelectionWrapper::create(JS::GlobalObject& global_object, Selection::Selection& impl)
{
    return global_object.heap().allocate<SelectionWrapper>(global_object, global_object, impl);
}


SelectionWrapper::SelectionWrapper(JS::GlobalObject& global_object, Selection::Selection& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<SelectionPrototype>("Selection"))
    , m_impl(impl)
{
}

void SelectionWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "Selection"), JS::Attribute::Configurable);
}
...
SelectionWrapper* wrap(JS::GlobalObject& global_object, Selection::Selection& impl)
{
    return static_cast<SelectionWrapper*>(wrap_impl(global_object, impl));
}
