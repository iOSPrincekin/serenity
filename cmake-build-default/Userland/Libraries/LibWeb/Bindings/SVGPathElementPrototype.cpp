...
SVGPathElementPrototype::SVGPathElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"))

{
}

SVGPathElementPrototype::~SVGPathElementPrototype()
{
}

void SVGPathElementPrototype::initialize(JS::GlobalObject& global_object)
{
