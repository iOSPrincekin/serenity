...
#if __has_include(<LibWeb/Crypto/HTMLTemplateElement.h>)
#    include <LibWeb/Crypto/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/CSS/HTMLTemplateElement.h>)
#    include <LibWeb/CSS/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/DOM/HTMLTemplateElement.h>)
#    include <LibWeb/DOM/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLTemplateElement.h>)
#    include <LibWeb/Encoding/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLTemplateElement.h>)
#    include <LibWeb/Geometry/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/HTML/HTMLTemplateElement.h>)
#    include <LibWeb/HTML/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLTemplateElement.h>)
#    include <LibWeb/UIEvents/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLTemplateElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLTemplateElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLTemplateElement.h>)
#    include <LibWeb/NavigationTiming/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLTemplateElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLTemplateElement.h>)
#    include <LibWeb/ResizeObserver/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/SVG/HTMLTemplateElement.h>)
#    include <LibWeb/SVG/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/Selection/HTMLTemplateElement.h>)
#    include <LibWeb/Selection/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLTemplateElement.h>)
#    include <LibWeb/WebSockets/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/XHR/HTMLTemplateElement.h>)
#    include <LibWeb/XHR/HTMLTemplateElement.h>
#elif __has_include(<LibWeb/URL/HTMLTemplateElement.h>)
#    include <LibWeb/URL/HTMLTemplateElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/HTMLTemplateElementWrapper.h>)
#   include <LibWeb/Bindings/HTMLTemplateElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/HTMLTemplateElementWrapperFactory.h>)
#   include <LibWeb/Bindings/HTMLTemplateElementWrapperFactory.h>
#endif
...
HTMLTemplateElementConstructor::HTMLTemplateElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLTemplateElementConstructor::~HTMLTemplateElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLTemplateElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLTemplateElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLTemplateElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLTemplateElement");

}

void HTMLTemplateElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLTemplateElementPrototype>("HTMLTemplateElement"), 0);
