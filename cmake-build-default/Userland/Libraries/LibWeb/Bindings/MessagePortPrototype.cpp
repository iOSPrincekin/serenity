...
MessagePortPrototype::MessagePortPrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void MessagePortPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_function("start", start, 0, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<HTML::MessagePort*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<MessagePortWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::MessagePort");

    return &static_cast<MessagePortWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::onmessage_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::onmessage_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::onmessageerror_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::onmessageerror_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::post_message)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->post_message(message); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::start)
{

    auto* impl = TRY(impl_from(vm, global_object));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->start(); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::close)
{
