...
HTMLDListElementPrototype::HTMLDListElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLDListElementPrototype::~HTMLDListElementPrototype()
{
}

void HTMLDListElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLDListElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLDListElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLDListElement");

    return &static_cast<HTMLDListElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDListElementPrototype::compact_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDListElementPrototype::compact_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
