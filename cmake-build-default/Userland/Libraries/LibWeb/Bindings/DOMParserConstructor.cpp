...
#if __has_include(<LibWeb/Crypto/DOMParser.h>)
#    include <LibWeb/Crypto/DOMParser.h>
#elif __has_include(<LibWeb/CSS/DOMParser.h>)
#    include <LibWeb/CSS/DOMParser.h>
#elif __has_include(<LibWeb/DOM/DOMParser.h>)
#    include <LibWeb/DOM/DOMParser.h>
#elif __has_include(<LibWeb/Encoding/DOMParser.h>)
#    include <LibWeb/Encoding/DOMParser.h>
#elif __has_include(<LibWeb/Geometry/DOMParser.h>)
#    include <LibWeb/Geometry/DOMParser.h>
#elif __has_include(<LibWeb/HTML/DOMParser.h>)
#    include <LibWeb/HTML/DOMParser.h>
#elif __has_include(<LibWeb/UIEvents/DOMParser.h>)
#    include <LibWeb/UIEvents/DOMParser.h>
#elif __has_include(<LibWeb/HighResolutionTime/DOMParser.h>)
#    include <LibWeb/HighResolutionTime/DOMParser.h>
#elif __has_include(<LibWeb/IntersectionObserver/DOMParser.h>)
#    include <LibWeb/IntersectionObserver/DOMParser.h>
#elif __has_include(<LibWeb/NavigationTiming/DOMParser.h>)
#    include <LibWeb/NavigationTiming/DOMParser.h>
#elif __has_include(<LibWeb/RequestIdleCallback/DOMParser.h>)
#    include <LibWeb/RequestIdleCallback/DOMParser.h>
#elif __has_include(<LibWeb/ResizeObserver/DOMParser.h>)
#    include <LibWeb/ResizeObserver/DOMParser.h>
#elif __has_include(<LibWeb/SVG/DOMParser.h>)
#    include <LibWeb/SVG/DOMParser.h>
#elif __has_include(<LibWeb/Selection/DOMParser.h>)
#    include <LibWeb/Selection/DOMParser.h>
#elif __has_include(<LibWeb/WebSockets/DOMParser.h>)
#    include <LibWeb/WebSockets/DOMParser.h>
#elif __has_include(<LibWeb/XHR/DOMParser.h>)
#    include <LibWeb/XHR/DOMParser.h>
#elif __has_include(<LibWeb/URL/DOMParser.h>)
#    include <LibWeb/URL/DOMParser.h>
#endif
...
#if __has_include(<LibWeb/Bindings/DOMParserWrapper.h>)
#   include <LibWeb/Bindings/DOMParserWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/DOMParserWrapperFactory.h>)
#   include <LibWeb/Bindings/DOMParserWrapperFactory.h>
#endif
...
DOMParserConstructor::DOMParserConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

DOMParserConstructor::~DOMParserConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DOMParserConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "DOMParser");
}

JS::ThrowCompletionOr<JS::Object*> DOMParserConstructor::construct(FunctionObject&)
{
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return HTML::DOMParser::create_with_global_object(window); }));

    return wrap(global_object, *impl);

}

void DOMParserConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    auto& window = static_cast<WindowObject&>(global_object);
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<DOMParserPrototype>("DOMParser"), 0);
