...
#if __has_include(<LibWeb/Crypto/HTMLTableSectionElement.h>)
#    include <LibWeb/Crypto/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/CSS/HTMLTableSectionElement.h>)
#    include <LibWeb/CSS/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/DOM/HTMLTableSectionElement.h>)
#    include <LibWeb/DOM/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLTableSectionElement.h>)
#    include <LibWeb/Encoding/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLTableSectionElement.h>)
#    include <LibWeb/Geometry/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/HTML/HTMLTableSectionElement.h>)
#    include <LibWeb/HTML/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLTableSectionElement.h>)
#    include <LibWeb/UIEvents/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLTableSectionElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLTableSectionElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLTableSectionElement.h>)
#    include <LibWeb/NavigationTiming/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLTableSectionElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLTableSectionElement.h>)
#    include <LibWeb/ResizeObserver/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/SVG/HTMLTableSectionElement.h>)
#    include <LibWeb/SVG/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/Selection/HTMLTableSectionElement.h>)
#    include <LibWeb/Selection/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLTableSectionElement.h>)
#    include <LibWeb/WebSockets/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/XHR/HTMLTableSectionElement.h>)
#    include <LibWeb/XHR/HTMLTableSectionElement.h>
#elif __has_include(<LibWeb/URL/HTMLTableSectionElement.h>)
#    include <LibWeb/URL/HTMLTableSectionElement.h>
#endif
...
HTMLTableSectionElementConstructor::HTMLTableSectionElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLTableSectionElementConstructor::~HTMLTableSectionElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLTableSectionElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLTableSectionElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLTableSectionElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLTableSectionElement");

}

void HTMLTableSectionElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLTableSectionElementPrototype>("HTMLTableSectionElement"), 0);
