...
HTMLHeadingElementPrototype::HTMLHeadingElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLHeadingElementPrototype::~HTMLHeadingElementPrototype()
{
}

void HTMLHeadingElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLHeadingElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLHeadingElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLHeadingElement");

    return &static_cast<HTMLHeadingElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLHeadingElementPrototype::align_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLHeadingElementPrototype::align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
