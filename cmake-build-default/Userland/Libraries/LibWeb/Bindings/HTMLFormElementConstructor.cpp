...
#if __has_include(<LibWeb/Crypto/HTMLFormElement.h>)
#    include <LibWeb/Crypto/HTMLFormElement.h>
#elif __has_include(<LibWeb/CSS/HTMLFormElement.h>)
#    include <LibWeb/CSS/HTMLFormElement.h>
#elif __has_include(<LibWeb/DOM/HTMLFormElement.h>)
#    include <LibWeb/DOM/HTMLFormElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLFormElement.h>)
#    include <LibWeb/Encoding/HTMLFormElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLFormElement.h>)
#    include <LibWeb/Geometry/HTMLFormElement.h>
#elif __has_include(<LibWeb/HTML/HTMLFormElement.h>)
#    include <LibWeb/HTML/HTMLFormElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLFormElement.h>)
#    include <LibWeb/UIEvents/HTMLFormElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLFormElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLFormElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLFormElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLFormElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLFormElement.h>)
#    include <LibWeb/NavigationTiming/HTMLFormElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLFormElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLFormElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLFormElement.h>)
#    include <LibWeb/ResizeObserver/HTMLFormElement.h>
#elif __has_include(<LibWeb/SVG/HTMLFormElement.h>)
#    include <LibWeb/SVG/HTMLFormElement.h>
#elif __has_include(<LibWeb/Selection/HTMLFormElement.h>)
#    include <LibWeb/Selection/HTMLFormElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLFormElement.h>)
#    include <LibWeb/WebSockets/HTMLFormElement.h>
#elif __has_include(<LibWeb/XHR/HTMLFormElement.h>)
#    include <LibWeb/XHR/HTMLFormElement.h>
#elif __has_include(<LibWeb/URL/HTMLFormElement.h>)
#    include <LibWeb/URL/HTMLFormElement.h>
#endif
...
HTMLFormElementConstructor::HTMLFormElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLFormElementConstructor::~HTMLFormElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLFormElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLFormElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLFormElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLFormElement");

}

void HTMLFormElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLFormElementPrototype>("HTMLFormElement"), 0);
