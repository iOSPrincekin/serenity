...
#if __has_include(<LibWeb/Crypto/SVGPolylineElement.h>)
#    include <LibWeb/Crypto/SVGPolylineElement.h>
#elif __has_include(<LibWeb/CSS/SVGPolylineElement.h>)
#    include <LibWeb/CSS/SVGPolylineElement.h>
#elif __has_include(<LibWeb/DOM/SVGPolylineElement.h>)
#    include <LibWeb/DOM/SVGPolylineElement.h>
#elif __has_include(<LibWeb/Encoding/SVGPolylineElement.h>)
#    include <LibWeb/Encoding/SVGPolylineElement.h>
#elif __has_include(<LibWeb/Geometry/SVGPolylineElement.h>)
#    include <LibWeb/Geometry/SVGPolylineElement.h>
#elif __has_include(<LibWeb/HTML/SVGPolylineElement.h>)
#    include <LibWeb/HTML/SVGPolylineElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGPolylineElement.h>)
#    include <LibWeb/UIEvents/SVGPolylineElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGPolylineElement.h>)
#    include <LibWeb/HighResolutionTime/SVGPolylineElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGPolylineElement.h>)
#    include <LibWeb/IntersectionObserver/SVGPolylineElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGPolylineElement.h>)
#    include <LibWeb/NavigationTiming/SVGPolylineElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGPolylineElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGPolylineElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGPolylineElement.h>)
#    include <LibWeb/ResizeObserver/SVGPolylineElement.h>
#elif __has_include(<LibWeb/SVG/SVGPolylineElement.h>)
#    include <LibWeb/SVG/SVGPolylineElement.h>
#elif __has_include(<LibWeb/Selection/SVGPolylineElement.h>)
#    include <LibWeb/Selection/SVGPolylineElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGPolylineElement.h>)
#    include <LibWeb/WebSockets/SVGPolylineElement.h>
#elif __has_include(<LibWeb/XHR/SVGPolylineElement.h>)
#    include <LibWeb/XHR/SVGPolylineElement.h>
#elif __has_include(<LibWeb/URL/SVGPolylineElement.h>)
#    include <LibWeb/URL/SVGPolylineElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/SVGPolylineElementWrapper.h>)
#   include <LibWeb/Bindings/SVGPolylineElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/SVGPolylineElementWrapperFactory.h>)
#   include <LibWeb/Bindings/SVGPolylineElementWrapperFactory.h>
#endif
...
SVGPolylineElementConstructor::SVGPolylineElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGPolylineElementConstructor::~SVGPolylineElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGPolylineElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGPolylineElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGPolylineElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGPolylineElement");

}

void SVGPolylineElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGPolylineElementPrototype>("SVGPolylineElement"), 0);
