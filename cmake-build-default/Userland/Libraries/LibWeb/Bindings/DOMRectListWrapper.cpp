...
DOMRectListWrapper* DOMRectListWrapper::create(JS::GlobalObject& global_object, Geometry::DOMRectList& impl)
{
    return global_object.heap().allocate<DOMRectListWrapper>(global_object, global_object, impl);
}


DOMRectListWrapper::DOMRectListWrapper(JS::GlobalObject& global_object, Geometry::DOMRectList& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<DOMRectListPrototype>("DOMRectList"))
    , m_impl(impl)
{
}

void DOMRectListWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "DOMRectList"), JS::Attribute::Configurable);
}

DOMRectListWrapper::~DOMRectListWrapper()
{
}

DOMRectListWrapper* wrap(JS::GlobalObject& global_object, Geometry::DOMRectList& impl)
{
    return static_cast<DOMRectListWrapper*>(wrap_impl(global_object, impl));
}
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> DOMRectListWrapper::legacy_platform_object_get_own_property_for_get_own_property_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> DOMRectListWrapper::legacy_platform_object_get_own_property_for_set_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> DOMRectListWrapper::internal_get_own_property(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<bool> DOMRectListWrapper::internal_set(JS::PropertyKey const& property_name, JS::Value value, JS::Value receiver)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> DOMRectListWrapper::internal_define_own_property(JS::PropertyKey const& property_name, JS::PropertyDescriptor const& property_descriptor)
{
...
JS::ThrowCompletionOr<bool> DOMRectListWrapper::internal_delete(JS::PropertyKey const& property_name)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> DOMRectListWrapper::internal_prevent_extensions()
{
    // 1. Return false.
    return false;
}

JS::ThrowCompletionOr<JS::MarkedVector<JS::Value>> DOMRectListWrapper::internal_own_property_keys() const
{
    auto& vm = this->vm();
