...
#include <LibWeb/Bindings/ResizeObserverWrapper.h>
...
#if __has_include(<LibWeb/Crypto/ResizeObserver.h>)
#    include <LibWeb/Crypto/ResizeObserver.h>
#elif __has_include(<LibWeb/CSS/ResizeObserver.h>)
#    include <LibWeb/CSS/ResizeObserver.h>
#elif __has_include(<LibWeb/DOM/ResizeObserver.h>)
#    include <LibWeb/DOM/ResizeObserver.h>
#elif __has_include(<LibWeb/Encoding/ResizeObserver.h>)
#    include <LibWeb/Encoding/ResizeObserver.h>
#elif __has_include(<LibWeb/Geometry/ResizeObserver.h>)
#    include <LibWeb/Geometry/ResizeObserver.h>
#elif __has_include(<LibWeb/HTML/ResizeObserver.h>)
#    include <LibWeb/HTML/ResizeObserver.h>
#elif __has_include(<LibWeb/UIEvents/ResizeObserver.h>)
#    include <LibWeb/UIEvents/ResizeObserver.h>
#elif __has_include(<LibWeb/HighResolutionTime/ResizeObserver.h>)
#    include <LibWeb/HighResolutionTime/ResizeObserver.h>
#elif __has_include(<LibWeb/IntersectionObserver/ResizeObserver.h>)
#    include <LibWeb/IntersectionObserver/ResizeObserver.h>
#elif __has_include(<LibWeb/NavigationTiming/ResizeObserver.h>)
#    include <LibWeb/NavigationTiming/ResizeObserver.h>
#elif __has_include(<LibWeb/RequestIdleCallback/ResizeObserver.h>)
#    include <LibWeb/RequestIdleCallback/ResizeObserver.h>
#elif __has_include(<LibWeb/ResizeObserver/ResizeObserver.h>)
#    include <LibWeb/ResizeObserver/ResizeObserver.h>
#elif __has_include(<LibWeb/SVG/ResizeObserver.h>)
#    include <LibWeb/SVG/ResizeObserver.h>
#elif __has_include(<LibWeb/Selection/ResizeObserver.h>)
#    include <LibWeb/Selection/ResizeObserver.h>
#elif __has_include(<LibWeb/WebSockets/ResizeObserver.h>)
#    include <LibWeb/WebSockets/ResizeObserver.h>
#elif __has_include(<LibWeb/XHR/ResizeObserver.h>)
#    include <LibWeb/XHR/ResizeObserver.h>
#elif __has_include(<LibWeb/URL/ResizeObserver.h>)
#    include <LibWeb/URL/ResizeObserver.h>
#endif
...
#if __has_include(<LibWeb/Bindings/ResizeObserverWrapper.h>)
#   include <LibWeb/Bindings/ResizeObserverWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/ResizeObserverWrapperFactory.h>)
#   include <LibWeb/Bindings/ResizeObserverWrapperFactory.h>
#endif
...
ResizeObserverConstructor::ResizeObserverConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> ResizeObserverConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "ResizeObserver");
}

JS::ThrowCompletionOr<JS::Object*> ResizeObserverConstructor::construct(FunctionObject&)
{
    ...
    if (vm.argument_count() < 1)
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::BadArgCountOne, "ResizeObserver");
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return ResizeObserver::ResizeObserver::create_with_global_object(window, callback); }));

    return wrap(global_object, *impl);

}

void ResizeObserverConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    auto& window = static_cast<WindowObject&>(global_object);
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<ResizeObserverPrototype>("ResizeObserver"), 0);
