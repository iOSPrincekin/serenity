...
CSSRuleListPrototype::CSSRuleListPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

CSSRuleListPrototype::~CSSRuleListPrototype()
{
}

void CSSRuleListPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<CSS::CSSRuleList*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<CSSRuleListWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "CSS::CSSRuleList");

    return &static_cast<CSSRuleListWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(CSSRuleListPrototype::length_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(CSSRuleListPrototype::item)
{
