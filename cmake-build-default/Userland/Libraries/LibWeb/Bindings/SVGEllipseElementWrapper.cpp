...
SVGEllipseElementWrapper* SVGEllipseElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGEllipseElement& impl)
{
    return global_object.heap().allocate<SVGEllipseElementWrapper>(global_object, global_object, impl);
}


SVGEllipseElementWrapper::SVGEllipseElementWrapper(JS::GlobalObject& global_object, SVG::SVGEllipseElement& impl)
    : SVGGeometryElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGEllipseElementPrototype>("SVGEllipseElement"));
}

void SVGEllipseElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGeometryElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGEllipseElement"), JS::Attribute::Configurable);
}

SVGEllipseElementWrapper::~SVGEllipseElementWrapper()
{
}
