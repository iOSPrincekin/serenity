...
DOMParserWrapper* DOMParserWrapper::create(JS::GlobalObject& global_object, HTML::DOMParser& impl)
{
    return global_object.heap().allocate<DOMParserWrapper>(global_object, global_object, impl);
}


DOMParserWrapper::DOMParserWrapper(JS::GlobalObject& global_object, HTML::DOMParser& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<DOMParserPrototype>("DOMParser"))
    , m_impl(impl)
{
}

void DOMParserWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "DOMParser"), JS::Attribute::Configurable);
}

DOMParserWrapper::~DOMParserWrapper()
{
}

DOMParserWrapper* wrap(JS::GlobalObject& global_object, HTML::DOMParser& impl)
{
    return static_cast<DOMParserWrapper*>(wrap_impl(global_object, impl));
}
