...
#if __has_include(<LibWeb/Crypto/SVGLineElement.h>)
#    include <LibWeb/Crypto/SVGLineElement.h>
#elif __has_include(<LibWeb/CSS/SVGLineElement.h>)
#    include <LibWeb/CSS/SVGLineElement.h>
#elif __has_include(<LibWeb/DOM/SVGLineElement.h>)
#    include <LibWeb/DOM/SVGLineElement.h>
#elif __has_include(<LibWeb/Encoding/SVGLineElement.h>)
#    include <LibWeb/Encoding/SVGLineElement.h>
#elif __has_include(<LibWeb/Geometry/SVGLineElement.h>)
#    include <LibWeb/Geometry/SVGLineElement.h>
#elif __has_include(<LibWeb/HTML/SVGLineElement.h>)
#    include <LibWeb/HTML/SVGLineElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGLineElement.h>)
#    include <LibWeb/UIEvents/SVGLineElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGLineElement.h>)
#    include <LibWeb/HighResolutionTime/SVGLineElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGLineElement.h>)
#    include <LibWeb/IntersectionObserver/SVGLineElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGLineElement.h>)
#    include <LibWeb/NavigationTiming/SVGLineElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGLineElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGLineElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGLineElement.h>)
#    include <LibWeb/ResizeObserver/SVGLineElement.h>
#elif __has_include(<LibWeb/SVG/SVGLineElement.h>)
#    include <LibWeb/SVG/SVGLineElement.h>
#elif __has_include(<LibWeb/Selection/SVGLineElement.h>)
#    include <LibWeb/Selection/SVGLineElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGLineElement.h>)
#    include <LibWeb/WebSockets/SVGLineElement.h>
#elif __has_include(<LibWeb/XHR/SVGLineElement.h>)
#    include <LibWeb/XHR/SVGLineElement.h>
#elif __has_include(<LibWeb/URL/SVGLineElement.h>)
#    include <LibWeb/URL/SVGLineElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/SVGLineElementWrapper.h>)
#   include <LibWeb/Bindings/SVGLineElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/SVGLineElementWrapperFactory.h>)
#   include <LibWeb/Bindings/SVGLineElementWrapperFactory.h>
#endif
...
SVGLineElementConstructor::SVGLineElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGLineElementConstructor::~SVGLineElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGLineElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGLineElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGLineElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGLineElement");

}

void SVGLineElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGLineElementPrototype>("SVGLineElement"), 0);
