...
#if __has_include(<LibWeb/Crypto/Element.h>)
#    include <LibWeb/Crypto/Element.h>
#elif __has_include(<LibWeb/CSS/Element.h>)
#    include <LibWeb/CSS/Element.h>
#elif __has_include(<LibWeb/DOM/Element.h>)
#    include <LibWeb/DOM/Element.h>
#elif __has_include(<LibWeb/Encoding/Element.h>)
#    include <LibWeb/Encoding/Element.h>
#elif __has_include(<LibWeb/Geometry/Element.h>)
#    include <LibWeb/Geometry/Element.h>
#elif __has_include(<LibWeb/HTML/Element.h>)
#    include <LibWeb/HTML/Element.h>
#elif __has_include(<LibWeb/UIEvents/Element.h>)
#    include <LibWeb/UIEvents/Element.h>
#elif __has_include(<LibWeb/HighResolutionTime/Element.h>)
#    include <LibWeb/HighResolutionTime/Element.h>
#elif __has_include(<LibWeb/IntersectionObserver/Element.h>)
#    include <LibWeb/IntersectionObserver/Element.h>
#elif __has_include(<LibWeb/NavigationTiming/Element.h>)
#    include <LibWeb/NavigationTiming/Element.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Element.h>)
#    include <LibWeb/RequestIdleCallback/Element.h>
#elif __has_include(<LibWeb/ResizeObserver/Element.h>)
#    include <LibWeb/ResizeObserver/Element.h>
#elif __has_include(<LibWeb/SVG/Element.h>)
#    include <LibWeb/SVG/Element.h>
#elif __has_include(<LibWeb/Selection/Element.h>)
#    include <LibWeb/Selection/Element.h>
#elif __has_include(<LibWeb/WebSockets/Element.h>)
#    include <LibWeb/WebSockets/Element.h>
#elif __has_include(<LibWeb/XHR/Element.h>)
#    include <LibWeb/XHR/Element.h>
#elif __has_include(<LibWeb/URL/Element.h>)
#    include <LibWeb/URL/Element.h>
#endif
...
ElementConstructor::ElementConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> ElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Element");
}

JS::ThrowCompletionOr<JS::Object*> ElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "Element");

}

void ElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<ElementPrototype>("Element"), 0);
