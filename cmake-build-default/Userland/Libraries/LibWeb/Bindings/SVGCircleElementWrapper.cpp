...
SVGCircleElementWrapper* SVGCircleElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGCircleElement& impl)
{
    return global_object.heap().allocate<SVGCircleElementWrapper>(global_object, global_object, impl);
}


SVGCircleElementWrapper::SVGCircleElementWrapper(JS::GlobalObject& global_object, SVG::SVGCircleElement& impl)
    : SVGGeometryElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGCircleElementPrototype>("SVGCircleElement"));
}

void SVGCircleElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGeometryElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGCircleElement"), JS::Attribute::Configurable);
}

SVGCircleElementWrapper::~SVGCircleElementWrapper()
{
}
