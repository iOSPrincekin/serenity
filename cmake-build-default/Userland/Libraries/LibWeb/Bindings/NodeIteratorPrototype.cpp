...
NodeIteratorPrototype::NodeIteratorPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

NodeIteratorPrototype::~NodeIteratorPrototype()
{
}

void NodeIteratorPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("referenceNode", reference_node_getter, nullptr, default_attributes);

    define_native_accessor("pointerBeforeReferenceNode", pointer_before_reference_node_getter, nullptr, default_attributes);
...
static JS::ThrowCompletionOr<DOM::NodeIterator*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<NodeIteratorWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::NodeIterator");

    return &static_cast<NodeIteratorWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::reference_node_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->reference_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::pointer_before_reference_node_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->pointer_before_reference_node(); }));
