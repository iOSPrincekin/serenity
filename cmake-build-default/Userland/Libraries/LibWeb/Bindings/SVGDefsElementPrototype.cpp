...
SVGDefsElementPrototype::SVGDefsElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGraphicsElementPrototype>("SVGGraphicsElement"))

{
}

SVGDefsElementPrototype::~SVGDefsElementPrototype()
{
}

void SVGDefsElementPrototype::initialize(JS::GlobalObject& global_object)
{
