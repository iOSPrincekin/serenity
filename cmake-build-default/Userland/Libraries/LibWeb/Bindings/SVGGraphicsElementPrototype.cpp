...
SVGGraphicsElementPrototype::SVGGraphicsElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGElementPrototype>("SVGElement"))

{
}

SVGGraphicsElementPrototype::~SVGGraphicsElementPrototype()
{
}

void SVGGraphicsElementPrototype::initialize(JS::GlobalObject& global_object)
{
