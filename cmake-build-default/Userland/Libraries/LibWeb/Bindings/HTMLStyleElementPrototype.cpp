...
HTMLStyleElementPrototype::HTMLStyleElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLStyleElementPrototype::~HTMLStyleElementPrototype()
{
}

void HTMLStyleElementPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("sheet", sheet_getter, nullptr, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<HTML::HTMLStyleElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLStyleElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLStyleElement");

    return &static_cast<HTMLStyleElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::media_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::media_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::type_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::type_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::sheet_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->sheet(); }));
