...
HTMLSlotElementPrototype::HTMLSlotElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLSlotElementPrototype::~HTMLSlotElementPrototype()
{
}

void HTMLSlotElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLSlotElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLSlotElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLSlotElement");

    return &static_cast<HTMLSlotElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLSlotElementPrototype::name_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLSlotElementPrototype::name_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
