...
TreeWalkerPrototype::TreeWalkerPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

TreeWalkerPrototype::~TreeWalkerPrototype()
{
}

void TreeWalkerPrototype::initialize(JS::GlobalObject& global_object)
{
    [[maybe_unused]] auto& vm = this->vm();
    [[maybe_unused]] u8 default_attributes = JS::Attribute::Enumerable | JS::Attribute::Configurable | JS::Attribute::Writable;


    define_native_accessor("root", root_getter, nullptr, default_attributes);

    define_native_accessor("whatToShow", what_to_show_getter, nullptr, default_attributes);

    define_native_accessor("filter", filter_getter, nullptr, default_attributes);

    define_native_accessor("currentNode", current_node_getter, current_node_setter, default_attributes);

    define_native_function("previousNode", previous_node, 0, default_attributes);

    define_native_function("previousSibling", previous_sibling, 0, default_attributes);

    define_native_function("nextSibling", next_sibling, 0, default_attributes);

    define_native_function("parentNode", parent_node, 0, default_attributes);

    define_native_function("lastChild", last_child, 0, default_attributes);

    define_native_function("nextNode", next_node, 0, default_attributes);

    define_native_function("firstChild", first_child, 0, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<DOM::TreeWalker*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<TreeWalkerWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::TreeWalker");

    return &static_cast<TreeWalkerWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::root_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->root(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::what_to_show_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->what_to_show(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::filter_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->filter(); }));

    if (!retval) {
        return JS::js_null();
    } else {

    return wrap(global_object, const_cast<NodeFilter&>(*retval));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::current_node_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->current_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::current_node_setter)
{
    ...
    if (!value.is_object() || !is<NodeWrapper>(value.as_object()))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "Node");

    auto& cpp_value = static_cast<NodeWrapper&>(value.as_object()).impl();

    TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->set_current_node(cpp_value); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::parent_node)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->parent_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::first_child)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->first_child(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::last_child)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->last_child(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::previous_sibling)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->previous_sibling(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::next_sibling)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->next_sibling(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::previous_node)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->previous_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::next_node)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->next_node(); }));
