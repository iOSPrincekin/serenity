...
#if __has_include(<LibWeb/Crypto/DOMImplementation.h>)
#    include <LibWeb/Crypto/DOMImplementation.h>
#elif __has_include(<LibWeb/CSS/DOMImplementation.h>)
#    include <LibWeb/CSS/DOMImplementation.h>
#elif __has_include(<LibWeb/DOM/DOMImplementation.h>)
#    include <LibWeb/DOM/DOMImplementation.h>
#elif __has_include(<LibWeb/Encoding/DOMImplementation.h>)
#    include <LibWeb/Encoding/DOMImplementation.h>
#elif __has_include(<LibWeb/Geometry/DOMImplementation.h>)
#    include <LibWeb/Geometry/DOMImplementation.h>
#elif __has_include(<LibWeb/HTML/DOMImplementation.h>)
#    include <LibWeb/HTML/DOMImplementation.h>
#elif __has_include(<LibWeb/UIEvents/DOMImplementation.h>)
#    include <LibWeb/UIEvents/DOMImplementation.h>
#elif __has_include(<LibWeb/HighResolutionTime/DOMImplementation.h>)
#    include <LibWeb/HighResolutionTime/DOMImplementation.h>
#elif __has_include(<LibWeb/IntersectionObserver/DOMImplementation.h>)
#    include <LibWeb/IntersectionObserver/DOMImplementation.h>
#elif __has_include(<LibWeb/NavigationTiming/DOMImplementation.h>)
#    include <LibWeb/NavigationTiming/DOMImplementation.h>
#elif __has_include(<LibWeb/RequestIdleCallback/DOMImplementation.h>)
#    include <LibWeb/RequestIdleCallback/DOMImplementation.h>
#elif __has_include(<LibWeb/ResizeObserver/DOMImplementation.h>)
#    include <LibWeb/ResizeObserver/DOMImplementation.h>
#elif __has_include(<LibWeb/SVG/DOMImplementation.h>)
#    include <LibWeb/SVG/DOMImplementation.h>
#elif __has_include(<LibWeb/Selection/DOMImplementation.h>)
#    include <LibWeb/Selection/DOMImplementation.h>
#elif __has_include(<LibWeb/WebSockets/DOMImplementation.h>)
#    include <LibWeb/WebSockets/DOMImplementation.h>
#elif __has_include(<LibWeb/XHR/DOMImplementation.h>)
#    include <LibWeb/XHR/DOMImplementation.h>
#elif __has_include(<LibWeb/URL/DOMImplementation.h>)
#    include <LibWeb/URL/DOMImplementation.h>
#endif
...
DOMImplementationConstructor::DOMImplementationConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

DOMImplementationConstructor::~DOMImplementationConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DOMImplementationConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "DOMImplementation");
}

JS::ThrowCompletionOr<JS::Object*> DOMImplementationConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "DOMImplementation");

}

void DOMImplementationConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<DOMImplementationPrototype>("DOMImplementation"), 0);
