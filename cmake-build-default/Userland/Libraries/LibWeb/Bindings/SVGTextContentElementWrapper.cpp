...
SVGTextContentElementWrapper* SVGTextContentElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGTextContentElement& impl)
{
    return global_object.heap().allocate<SVGTextContentElementWrapper>(global_object, global_object, impl);
}


SVGTextContentElementWrapper::SVGTextContentElementWrapper(JS::GlobalObject& global_object, SVG::SVGTextContentElement& impl)
    : SVGGraphicsElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGTextContentElementPrototype>("SVGTextContentElement"));
}

void SVGTextContentElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGraphicsElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGTextContentElement"), JS::Attribute::Configurable);
}

SVGTextContentElementWrapper::~SVGTextContentElementWrapper()
{
}
