...
HTMLScriptElementPrototype::HTMLScriptElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void HTMLScriptElementPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("noModule", no_module_getter, no_module_setter, default_attributes);

    define_native_accessor("defer", defer_getter, defer_setter, default_attributes);
    ...
    define_native_accessor("event", event_getter, event_setter, default_attributes);
...
static JS::ThrowCompletionOr<HTML::HTMLScriptElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLScriptElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLScriptElement");

    return &static_cast<HTMLScriptElementWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(HTMLScriptElementPrototype::no_module_getter)
{
    ...
    auto retval = impl->has_attribute(HTML::AttributeNames::nomodule);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLScriptElementPrototype::no_module_setter)
{
    ...
    if (!cpp_value)
        impl->remove_attribute(HTML::AttributeNames::nomodule);
    else
        impl->set_attribute(HTML::AttributeNames::nomodule, String::empty());
...
JS_DEFINE_NATIVE_FUNCTION(HTMLScriptElementPrototype::defer_getter)
{
    ...
    auto retval = impl->has_attribute(HTML::AttributeNames::defer);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLScriptElementPrototype::defer_setter)
{
    ...
    if (!cpp_value)
        impl->remove_attribute(HTML::AttributeNames::defer);
    else
        impl->set_attribute(HTML::AttributeNames::defer, String::empty());
...
JS_DEFINE_NATIVE_FUNCTION(HTMLScriptElementPrototype::event_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::event);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLScriptElementPrototype::event_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::event, cpp_value);
