...
SVGRectElementWrapper* SVGRectElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGRectElement& impl)
{
    return global_object.heap().allocate<SVGRectElementWrapper>(global_object, global_object, impl);
}


SVGRectElementWrapper::SVGRectElementWrapper(JS::GlobalObject& global_object, SVG::SVGRectElement& impl)
    : SVGGeometryElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGRectElementPrototype>("SVGRectElement"));
}

void SVGRectElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGeometryElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGRectElement"), JS::Attribute::Configurable);
}

SVGRectElementWrapper::~SVGRectElementWrapper()
{
}
