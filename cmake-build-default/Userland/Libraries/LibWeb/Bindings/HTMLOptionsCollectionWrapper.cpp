...
HTMLOptionsCollectionWrapper* HTMLOptionsCollectionWrapper::create(JS::GlobalObject& global_object, HTML::HTMLOptionsCollection& impl)
{
    return global_object.heap().allocate<HTMLOptionsCollectionWrapper>(global_object, global_object, impl);
}


HTMLOptionsCollectionWrapper::HTMLOptionsCollectionWrapper(JS::GlobalObject& global_object, HTML::HTMLOptionsCollection& impl)
    : HTMLCollectionWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLOptionsCollectionPrototype>("HTMLOptionsCollection"));
}

void HTMLOptionsCollectionWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLCollectionWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLOptionsCollection"), JS::Attribute::Configurable);
}

HTMLOptionsCollectionWrapper::~HTMLOptionsCollectionWrapper()
{
}

HTMLOptionsCollectionWrapper* wrap(JS::GlobalObject& global_object, HTML::HTMLOptionsCollection& impl)
{
    return static_cast<HTMLOptionsCollectionWrapper*>(wrap_impl(global_object, impl));
}
