...
HTMLTableRowElementWrapper* HTMLTableRowElementWrapper::create(JS::GlobalObject& global_object, HTML::HTMLTableRowElement& impl)
{
    return global_object.heap().allocate<HTMLTableRowElementWrapper>(global_object, global_object, impl);
}


HTMLTableRowElementWrapper::HTMLTableRowElementWrapper(JS::GlobalObject& global_object, HTML::HTMLTableRowElement& impl)
    : HTMLElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLTableRowElementPrototype>("HTMLTableRowElement"));
}

void HTMLTableRowElementWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLTableRowElement"), JS::Attribute::Configurable);
}

HTMLTableRowElementWrapper::~HTMLTableRowElementWrapper()
{
}
