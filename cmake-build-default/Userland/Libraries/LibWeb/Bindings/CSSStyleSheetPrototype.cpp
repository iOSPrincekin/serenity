...
#if __has_include(<LibWeb/Bindings/StyleSheetPrototype.h>)
...
CSSStyleSheetPrototype::CSSStyleSheetPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<StyleSheetPrototype>("StyleSheet"))

{
}

CSSStyleSheetPrototype::~CSSStyleSheetPrototype()
{
}

void CSSStyleSheetPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_function("removeRule", remove_rule, 1, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<CSS::CSSStyleSheet*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<CSSStyleSheetWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "CSS::CSSStyleSheet");

    return &static_cast<CSSStyleSheetWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(CSSStyleSheetPrototype::css_rules_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->css_rules(); }));
...
JS_DEFINE_NATIVE_FUNCTION(CSSStyleSheetPrototype::remove_rule)
{
    ...
    if (vm.argument_count() < 1)
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::BadArgCountOne, "removeRule");
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->remove_rule(index); }));
