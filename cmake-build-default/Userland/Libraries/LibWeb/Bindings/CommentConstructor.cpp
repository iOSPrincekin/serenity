...
#if __has_include(<LibWeb/Crypto/Comment.h>)
#    include <LibWeb/Crypto/Comment.h>
#elif __has_include(<LibWeb/CSS/Comment.h>)
#    include <LibWeb/CSS/Comment.h>
#elif __has_include(<LibWeb/DOM/Comment.h>)
#    include <LibWeb/DOM/Comment.h>
#elif __has_include(<LibWeb/Encoding/Comment.h>)
#    include <LibWeb/Encoding/Comment.h>
#elif __has_include(<LibWeb/Geometry/Comment.h>)
#    include <LibWeb/Geometry/Comment.h>
#elif __has_include(<LibWeb/HTML/Comment.h>)
#    include <LibWeb/HTML/Comment.h>
#elif __has_include(<LibWeb/UIEvents/Comment.h>)
#    include <LibWeb/UIEvents/Comment.h>
#elif __has_include(<LibWeb/HighResolutionTime/Comment.h>)
#    include <LibWeb/HighResolutionTime/Comment.h>
#elif __has_include(<LibWeb/IntersectionObserver/Comment.h>)
#    include <LibWeb/IntersectionObserver/Comment.h>
#elif __has_include(<LibWeb/NavigationTiming/Comment.h>)
#    include <LibWeb/NavigationTiming/Comment.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Comment.h>)
#    include <LibWeb/RequestIdleCallback/Comment.h>
#elif __has_include(<LibWeb/ResizeObserver/Comment.h>)
#    include <LibWeb/ResizeObserver/Comment.h>
#elif __has_include(<LibWeb/SVG/Comment.h>)
#    include <LibWeb/SVG/Comment.h>
#elif __has_include(<LibWeb/Selection/Comment.h>)
#    include <LibWeb/Selection/Comment.h>
#elif __has_include(<LibWeb/WebSockets/Comment.h>)
#    include <LibWeb/WebSockets/Comment.h>
#elif __has_include(<LibWeb/XHR/Comment.h>)
#    include <LibWeb/XHR/Comment.h>
#elif __has_include(<LibWeb/URL/Comment.h>)
#    include <LibWeb/URL/Comment.h>
#endif
...
CommentConstructor::CommentConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> CommentConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Comment");
}

JS::ThrowCompletionOr<JS::Object*> CommentConstructor::construct(FunctionObject&)
{
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return DOM::Comment::create_with_global_object(window, data); }));

    return wrap(global_object, *impl);

}

void CommentConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    auto& window = static_cast<WindowObject&>(global_object);
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<CommentPrototype>("Comment"), 0);
