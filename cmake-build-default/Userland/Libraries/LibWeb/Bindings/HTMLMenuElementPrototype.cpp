...
HTMLMenuElementPrototype::HTMLMenuElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLMenuElementPrototype::~HTMLMenuElementPrototype()
{
}

void HTMLMenuElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLMenuElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLMenuElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLMenuElement");

    return &static_cast<HTMLMenuElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLMenuElementPrototype::compact_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMenuElementPrototype::compact_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
