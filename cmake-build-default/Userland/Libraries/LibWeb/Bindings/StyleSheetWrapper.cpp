...
StyleSheetWrapper* StyleSheetWrapper::create(JS::GlobalObject& global_object, CSS::StyleSheet& impl)
{
    return global_object.heap().allocate<StyleSheetWrapper>(global_object, global_object, impl);
}


StyleSheetWrapper::StyleSheetWrapper(JS::GlobalObject& global_object, CSS::StyleSheet& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<StyleSheetPrototype>("StyleSheet"))
    , m_impl(impl)
{
}

void StyleSheetWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "StyleSheet"), JS::Attribute::Configurable);
}

StyleSheetWrapper::~StyleSheetWrapper()
{
}

StyleSheetWrapper* wrap(JS::GlobalObject& global_object, CSS::StyleSheet& impl)
{
    return static_cast<StyleSheetWrapper*>(wrap_impl(global_object, impl));
}
