...
#if __has_include(<LibWeb/Crypto/CharacterData.h>)
#    include <LibWeb/Crypto/CharacterData.h>
#elif __has_include(<LibWeb/CSS/CharacterData.h>)
#    include <LibWeb/CSS/CharacterData.h>
#elif __has_include(<LibWeb/DOM/CharacterData.h>)
#    include <LibWeb/DOM/CharacterData.h>
#elif __has_include(<LibWeb/Encoding/CharacterData.h>)
#    include <LibWeb/Encoding/CharacterData.h>
#elif __has_include(<LibWeb/Geometry/CharacterData.h>)
#    include <LibWeb/Geometry/CharacterData.h>
#elif __has_include(<LibWeb/HTML/CharacterData.h>)
#    include <LibWeb/HTML/CharacterData.h>
#elif __has_include(<LibWeb/UIEvents/CharacterData.h>)
#    include <LibWeb/UIEvents/CharacterData.h>
#elif __has_include(<LibWeb/HighResolutionTime/CharacterData.h>)
#    include <LibWeb/HighResolutionTime/CharacterData.h>
#elif __has_include(<LibWeb/IntersectionObserver/CharacterData.h>)
#    include <LibWeb/IntersectionObserver/CharacterData.h>
#elif __has_include(<LibWeb/NavigationTiming/CharacterData.h>)
#    include <LibWeb/NavigationTiming/CharacterData.h>
#elif __has_include(<LibWeb/RequestIdleCallback/CharacterData.h>)
#    include <LibWeb/RequestIdleCallback/CharacterData.h>
#elif __has_include(<LibWeb/ResizeObserver/CharacterData.h>)
#    include <LibWeb/ResizeObserver/CharacterData.h>
#elif __has_include(<LibWeb/SVG/CharacterData.h>)
#    include <LibWeb/SVG/CharacterData.h>
#elif __has_include(<LibWeb/Selection/CharacterData.h>)
#    include <LibWeb/Selection/CharacterData.h>
#elif __has_include(<LibWeb/WebSockets/CharacterData.h>)
#    include <LibWeb/WebSockets/CharacterData.h>
#elif __has_include(<LibWeb/XHR/CharacterData.h>)
#    include <LibWeb/XHR/CharacterData.h>
#elif __has_include(<LibWeb/URL/CharacterData.h>)
#    include <LibWeb/URL/CharacterData.h>
#endif
...
CharacterDataConstructor::CharacterDataConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

CharacterDataConstructor::~CharacterDataConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CharacterDataConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "CharacterData");
}

JS::ThrowCompletionOr<JS::Object*> CharacterDataConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "CharacterData");

}

void CharacterDataConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<CharacterDataPrototype>("CharacterData"), 0);
