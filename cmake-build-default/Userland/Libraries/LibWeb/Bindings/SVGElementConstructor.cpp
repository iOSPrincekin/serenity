...
#if __has_include(<LibWeb/Crypto/SVGElement.h>)
#    include <LibWeb/Crypto/SVGElement.h>
#elif __has_include(<LibWeb/CSS/SVGElement.h>)
#    include <LibWeb/CSS/SVGElement.h>
#elif __has_include(<LibWeb/DOM/SVGElement.h>)
#    include <LibWeb/DOM/SVGElement.h>
#elif __has_include(<LibWeb/Encoding/SVGElement.h>)
#    include <LibWeb/Encoding/SVGElement.h>
#elif __has_include(<LibWeb/Geometry/SVGElement.h>)
#    include <LibWeb/Geometry/SVGElement.h>
#elif __has_include(<LibWeb/HTML/SVGElement.h>)
#    include <LibWeb/HTML/SVGElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGElement.h>)
#    include <LibWeb/UIEvents/SVGElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGElement.h>)
#    include <LibWeb/HighResolutionTime/SVGElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGElement.h>)
#    include <LibWeb/IntersectionObserver/SVGElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGElement.h>)
#    include <LibWeb/NavigationTiming/SVGElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGElement.h>)
#    include <LibWeb/ResizeObserver/SVGElement.h>
#elif __has_include(<LibWeb/SVG/SVGElement.h>)
#    include <LibWeb/SVG/SVGElement.h>
#elif __has_include(<LibWeb/Selection/SVGElement.h>)
#    include <LibWeb/Selection/SVGElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGElement.h>)
#    include <LibWeb/WebSockets/SVGElement.h>
#elif __has_include(<LibWeb/XHR/SVGElement.h>)
#    include <LibWeb/XHR/SVGElement.h>
#elif __has_include(<LibWeb/URL/SVGElement.h>)
#    include <LibWeb/URL/SVGElement.h>
#endif
...
SVGElementConstructor::SVGElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGElementConstructor::~SVGElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGElement");

}

void SVGElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGElementPrototype>("SVGElement"), 0);
