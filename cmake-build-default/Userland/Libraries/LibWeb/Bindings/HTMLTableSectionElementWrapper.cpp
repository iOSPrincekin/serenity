...
HTMLTableSectionElementWrapper* HTMLTableSectionElementWrapper::create(JS::GlobalObject& global_object, HTML::HTMLTableSectionElement& impl)
{
    return global_object.heap().allocate<HTMLTableSectionElementWrapper>(global_object, global_object, impl);
}


HTMLTableSectionElementWrapper::HTMLTableSectionElementWrapper(JS::GlobalObject& global_object, HTML::HTMLTableSectionElement& impl)
    : HTMLElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLTableSectionElementPrototype>("HTMLTableSectionElement"));
}

void HTMLTableSectionElementWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLTableSectionElement"), JS::Attribute::Configurable);
}

HTMLTableSectionElementWrapper::~HTMLTableSectionElementWrapper()
{
}
