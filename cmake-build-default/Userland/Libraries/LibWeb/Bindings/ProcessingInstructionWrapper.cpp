...
ProcessingInstructionWrapper* ProcessingInstructionWrapper::create(JS::GlobalObject& global_object, DOM::ProcessingInstruction& impl)
{
    return global_object.heap().allocate<ProcessingInstructionWrapper>(global_object, global_object, impl);
}


ProcessingInstructionWrapper::ProcessingInstructionWrapper(JS::GlobalObject& global_object, DOM::ProcessingInstruction& impl)
    : CharacterDataWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<ProcessingInstructionPrototype>("ProcessingInstruction"));
}

void ProcessingInstructionWrapper::initialize(JS::GlobalObject& global_object)
{
    CharacterDataWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "ProcessingInstruction"), JS::Attribute::Configurable);
}

ProcessingInstructionWrapper::~ProcessingInstructionWrapper()
{
}

ProcessingInstructionWrapper* wrap(JS::GlobalObject& global_object, DOM::ProcessingInstruction& impl)
{
    return static_cast<ProcessingInstructionWrapper*>(wrap_impl(global_object, impl));
}
