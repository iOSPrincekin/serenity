...
#if __has_include(<LibWeb/Crypto/Text.h>)
#    include <LibWeb/Crypto/Text.h>
#elif __has_include(<LibWeb/CSS/Text.h>)
#    include <LibWeb/CSS/Text.h>
#elif __has_include(<LibWeb/DOM/Text.h>)
#    include <LibWeb/DOM/Text.h>
#elif __has_include(<LibWeb/Encoding/Text.h>)
#    include <LibWeb/Encoding/Text.h>
#elif __has_include(<LibWeb/Geometry/Text.h>)
#    include <LibWeb/Geometry/Text.h>
#elif __has_include(<LibWeb/HTML/Text.h>)
#    include <LibWeb/HTML/Text.h>
#elif __has_include(<LibWeb/UIEvents/Text.h>)
#    include <LibWeb/UIEvents/Text.h>
#elif __has_include(<LibWeb/HighResolutionTime/Text.h>)
#    include <LibWeb/HighResolutionTime/Text.h>
#elif __has_include(<LibWeb/IntersectionObserver/Text.h>)
#    include <LibWeb/IntersectionObserver/Text.h>
#elif __has_include(<LibWeb/NavigationTiming/Text.h>)
#    include <LibWeb/NavigationTiming/Text.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Text.h>)
#    include <LibWeb/RequestIdleCallback/Text.h>
#elif __has_include(<LibWeb/ResizeObserver/Text.h>)
#    include <LibWeb/ResizeObserver/Text.h>
#elif __has_include(<LibWeb/SVG/Text.h>)
#    include <LibWeb/SVG/Text.h>
#elif __has_include(<LibWeb/Selection/Text.h>)
#    include <LibWeb/Selection/Text.h>
#elif __has_include(<LibWeb/WebSockets/Text.h>)
#    include <LibWeb/WebSockets/Text.h>
#elif __has_include(<LibWeb/XHR/Text.h>)
#    include <LibWeb/XHR/Text.h>
#elif __has_include(<LibWeb/URL/Text.h>)
#    include <LibWeb/URL/Text.h>
#endif
...
TextConstructor::TextConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> TextConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Text");
}

JS::ThrowCompletionOr<JS::Object*> TextConstructor::construct(FunctionObject&)
{
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return DOM::Text::create_with_global_object(window, data); }));

    return wrap(global_object, *impl);

}

void TextConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    auto& window = static_cast<WindowObject&>(global_object);
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<TextPrototype>("Text"), 0);
