...
#include <LibWeb/Bindings/ProcessingInstructionWrapper.h>
...
#if __has_include(<LibWeb/Crypto/ProcessingInstruction.h>)
#    include <LibWeb/Crypto/ProcessingInstruction.h>
#elif __has_include(<LibWeb/CSS/ProcessingInstruction.h>)
#    include <LibWeb/CSS/ProcessingInstruction.h>
#elif __has_include(<LibWeb/DOM/ProcessingInstruction.h>)
#    include <LibWeb/DOM/ProcessingInstruction.h>
#elif __has_include(<LibWeb/Encoding/ProcessingInstruction.h>)
#    include <LibWeb/Encoding/ProcessingInstruction.h>
#elif __has_include(<LibWeb/Geometry/ProcessingInstruction.h>)
#    include <LibWeb/Geometry/ProcessingInstruction.h>
#elif __has_include(<LibWeb/HTML/ProcessingInstruction.h>)
#    include <LibWeb/HTML/ProcessingInstruction.h>
#elif __has_include(<LibWeb/UIEvents/ProcessingInstruction.h>)
#    include <LibWeb/UIEvents/ProcessingInstruction.h>
#elif __has_include(<LibWeb/HighResolutionTime/ProcessingInstruction.h>)
#    include <LibWeb/HighResolutionTime/ProcessingInstruction.h>
#elif __has_include(<LibWeb/IntersectionObserver/ProcessingInstruction.h>)
#    include <LibWeb/IntersectionObserver/ProcessingInstruction.h>
#elif __has_include(<LibWeb/NavigationTiming/ProcessingInstruction.h>)
#    include <LibWeb/NavigationTiming/ProcessingInstruction.h>
#elif __has_include(<LibWeb/RequestIdleCallback/ProcessingInstruction.h>)
#    include <LibWeb/RequestIdleCallback/ProcessingInstruction.h>
#elif __has_include(<LibWeb/ResizeObserver/ProcessingInstruction.h>)
#    include <LibWeb/ResizeObserver/ProcessingInstruction.h>
#elif __has_include(<LibWeb/SVG/ProcessingInstruction.h>)
#    include <LibWeb/SVG/ProcessingInstruction.h>
#elif __has_include(<LibWeb/Selection/ProcessingInstruction.h>)
#    include <LibWeb/Selection/ProcessingInstruction.h>
#elif __has_include(<LibWeb/WebSockets/ProcessingInstruction.h>)
#    include <LibWeb/WebSockets/ProcessingInstruction.h>
#elif __has_include(<LibWeb/XHR/ProcessingInstruction.h>)
#    include <LibWeb/XHR/ProcessingInstruction.h>
#elif __has_include(<LibWeb/URL/ProcessingInstruction.h>)
#    include <LibWeb/URL/ProcessingInstruction.h>
#endif
...
#if __has_include(<LibWeb/Bindings/ProcessingInstructionWrapper.h>)
#   include <LibWeb/Bindings/ProcessingInstructionWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/ProcessingInstructionWrapperFactory.h>)
#   include <LibWeb/Bindings/ProcessingInstructionWrapperFactory.h>
#endif
...
ProcessingInstructionConstructor::ProcessingInstructionConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

ProcessingInstructionConstructor::~ProcessingInstructionConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> ProcessingInstructionConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "ProcessingInstruction");
}

JS::ThrowCompletionOr<JS::Object*> ProcessingInstructionConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "ProcessingInstruction");

}

void ProcessingInstructionConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<ProcessingInstructionPrototype>("ProcessingInstruction"), 0);
