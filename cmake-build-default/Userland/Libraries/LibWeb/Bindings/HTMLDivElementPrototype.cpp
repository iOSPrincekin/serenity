...
HTMLDivElementPrototype::HTMLDivElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLDivElementPrototype::~HTMLDivElementPrototype()
{
}

void HTMLDivElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLDivElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLDivElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLDivElement");

    return &static_cast<HTMLDivElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDivElementPrototype::align_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDivElementPrototype::align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
