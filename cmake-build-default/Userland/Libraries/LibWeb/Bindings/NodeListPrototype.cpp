...
NodeListPrototype::NodeListPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

NodeListPrototype::~NodeListPrototype()
{
}

void NodeListPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<DOM::NodeList*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<NodeListWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::NodeList");

    return &static_cast<NodeListWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(NodeListPrototype::length_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(NodeListPrototype::item)
{
