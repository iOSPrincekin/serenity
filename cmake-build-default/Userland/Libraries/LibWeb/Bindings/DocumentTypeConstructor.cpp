...
#if __has_include(<LibWeb/Crypto/DocumentType.h>)
#    include <LibWeb/Crypto/DocumentType.h>
#elif __has_include(<LibWeb/CSS/DocumentType.h>)
#    include <LibWeb/CSS/DocumentType.h>
#elif __has_include(<LibWeb/DOM/DocumentType.h>)
#    include <LibWeb/DOM/DocumentType.h>
#elif __has_include(<LibWeb/Encoding/DocumentType.h>)
#    include <LibWeb/Encoding/DocumentType.h>
#elif __has_include(<LibWeb/Geometry/DocumentType.h>)
#    include <LibWeb/Geometry/DocumentType.h>
#elif __has_include(<LibWeb/HTML/DocumentType.h>)
#    include <LibWeb/HTML/DocumentType.h>
#elif __has_include(<LibWeb/UIEvents/DocumentType.h>)
#    include <LibWeb/UIEvents/DocumentType.h>
#elif __has_include(<LibWeb/HighResolutionTime/DocumentType.h>)
#    include <LibWeb/HighResolutionTime/DocumentType.h>
#elif __has_include(<LibWeb/IntersectionObserver/DocumentType.h>)
#    include <LibWeb/IntersectionObserver/DocumentType.h>
#elif __has_include(<LibWeb/NavigationTiming/DocumentType.h>)
#    include <LibWeb/NavigationTiming/DocumentType.h>
#elif __has_include(<LibWeb/RequestIdleCallback/DocumentType.h>)
#    include <LibWeb/RequestIdleCallback/DocumentType.h>
#elif __has_include(<LibWeb/ResizeObserver/DocumentType.h>)
#    include <LibWeb/ResizeObserver/DocumentType.h>
#elif __has_include(<LibWeb/SVG/DocumentType.h>)
#    include <LibWeb/SVG/DocumentType.h>
#elif __has_include(<LibWeb/Selection/DocumentType.h>)
#    include <LibWeb/Selection/DocumentType.h>
#elif __has_include(<LibWeb/WebSockets/DocumentType.h>)
#    include <LibWeb/WebSockets/DocumentType.h>
#elif __has_include(<LibWeb/XHR/DocumentType.h>)
#    include <LibWeb/XHR/DocumentType.h>
#elif __has_include(<LibWeb/URL/DocumentType.h>)
#    include <LibWeb/URL/DocumentType.h>
#endif
...
DocumentTypeConstructor::DocumentTypeConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

DocumentTypeConstructor::~DocumentTypeConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DocumentTypeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "DocumentType");
}

JS::ThrowCompletionOr<JS::Object*> DocumentTypeConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "DocumentType");

}

void DocumentTypeConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<DocumentTypePrototype>("DocumentType"), 0);
