...
SVGGeometryElementPrototype::SVGGeometryElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGraphicsElementPrototype>("SVGGraphicsElement"))

{
}

SVGGeometryElementPrototype::~SVGGeometryElementPrototype()
{
}

void SVGGeometryElementPrototype::initialize(JS::GlobalObject& global_object)
{
