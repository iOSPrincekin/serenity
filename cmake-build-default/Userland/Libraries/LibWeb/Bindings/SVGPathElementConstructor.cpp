...
#if __has_include(<LibWeb/Crypto/SVGPathElement.h>)
#    include <LibWeb/Crypto/SVGPathElement.h>
#elif __has_include(<LibWeb/CSS/SVGPathElement.h>)
#    include <LibWeb/CSS/SVGPathElement.h>
#elif __has_include(<LibWeb/DOM/SVGPathElement.h>)
#    include <LibWeb/DOM/SVGPathElement.h>
#elif __has_include(<LibWeb/Encoding/SVGPathElement.h>)
#    include <LibWeb/Encoding/SVGPathElement.h>
#elif __has_include(<LibWeb/Geometry/SVGPathElement.h>)
#    include <LibWeb/Geometry/SVGPathElement.h>
#elif __has_include(<LibWeb/HTML/SVGPathElement.h>)
#    include <LibWeb/HTML/SVGPathElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGPathElement.h>)
#    include <LibWeb/UIEvents/SVGPathElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGPathElement.h>)
#    include <LibWeb/HighResolutionTime/SVGPathElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGPathElement.h>)
#    include <LibWeb/IntersectionObserver/SVGPathElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGPathElement.h>)
#    include <LibWeb/NavigationTiming/SVGPathElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGPathElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGPathElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGPathElement.h>)
#    include <LibWeb/ResizeObserver/SVGPathElement.h>
#elif __has_include(<LibWeb/SVG/SVGPathElement.h>)
#    include <LibWeb/SVG/SVGPathElement.h>
#elif __has_include(<LibWeb/Selection/SVGPathElement.h>)
#    include <LibWeb/Selection/SVGPathElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGPathElement.h>)
#    include <LibWeb/WebSockets/SVGPathElement.h>
#elif __has_include(<LibWeb/XHR/SVGPathElement.h>)
#    include <LibWeb/XHR/SVGPathElement.h>
#elif __has_include(<LibWeb/URL/SVGPathElement.h>)
#    include <LibWeb/URL/SVGPathElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/SVGPathElementWrapper.h>)
#   include <LibWeb/Bindings/SVGPathElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/SVGPathElementWrapperFactory.h>)
#   include <LibWeb/Bindings/SVGPathElementWrapperFactory.h>
#endif
...
SVGPathElementConstructor::SVGPathElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGPathElementConstructor::~SVGPathElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGPathElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGPathElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGPathElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGPathElement");

}

void SVGPathElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGPathElementPrototype>("SVGPathElement"), 0);
