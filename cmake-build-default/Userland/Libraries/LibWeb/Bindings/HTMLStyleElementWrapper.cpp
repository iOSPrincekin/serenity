...
HTMLStyleElementWrapper* HTMLStyleElementWrapper::create(JS::GlobalObject& global_object, HTML::HTMLStyleElement& impl)
{
    return global_object.heap().allocate<HTMLStyleElementWrapper>(global_object, global_object, impl);
}


HTMLStyleElementWrapper::HTMLStyleElementWrapper(JS::GlobalObject& global_object, HTML::HTMLStyleElement& impl)
    : HTMLElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLStyleElementPrototype>("HTMLStyleElement"));
}

void HTMLStyleElementWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLStyleElement"), JS::Attribute::Configurable);
}

HTMLStyleElementWrapper::~HTMLStyleElementWrapper()
{
}
