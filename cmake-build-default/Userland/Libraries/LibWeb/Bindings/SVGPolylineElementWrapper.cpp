...
SVGPolylineElementWrapper* SVGPolylineElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGPolylineElement& impl)
{
    return global_object.heap().allocate<SVGPolylineElementWrapper>(global_object, global_object, impl);
}


SVGPolylineElementWrapper::SVGPolylineElementWrapper(JS::GlobalObject& global_object, SVG::SVGPolylineElement& impl)
    : SVGGeometryElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGPolylineElementPrototype>("SVGPolylineElement"));
}

void SVGPolylineElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGeometryElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGPolylineElement"), JS::Attribute::Configurable);
}

SVGPolylineElementWrapper::~SVGPolylineElementWrapper()
{
}
