...
#if __has_include(<LibWeb/Crypto/HTMLInputElement.h>)
#    include <LibWeb/Crypto/HTMLInputElement.h>
#elif __has_include(<LibWeb/CSS/HTMLInputElement.h>)
#    include <LibWeb/CSS/HTMLInputElement.h>
#elif __has_include(<LibWeb/DOM/HTMLInputElement.h>)
#    include <LibWeb/DOM/HTMLInputElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLInputElement.h>)
#    include <LibWeb/Encoding/HTMLInputElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLInputElement.h>)
#    include <LibWeb/Geometry/HTMLInputElement.h>
#elif __has_include(<LibWeb/HTML/HTMLInputElement.h>)
#    include <LibWeb/HTML/HTMLInputElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLInputElement.h>)
#    include <LibWeb/UIEvents/HTMLInputElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLInputElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLInputElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLInputElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLInputElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLInputElement.h>)
#    include <LibWeb/NavigationTiming/HTMLInputElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLInputElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLInputElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLInputElement.h>)
#    include <LibWeb/ResizeObserver/HTMLInputElement.h>
#elif __has_include(<LibWeb/SVG/HTMLInputElement.h>)
#    include <LibWeb/SVG/HTMLInputElement.h>
#elif __has_include(<LibWeb/Selection/HTMLInputElement.h>)
#    include <LibWeb/Selection/HTMLInputElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLInputElement.h>)
#    include <LibWeb/WebSockets/HTMLInputElement.h>
#elif __has_include(<LibWeb/XHR/HTMLInputElement.h>)
#    include <LibWeb/XHR/HTMLInputElement.h>
#elif __has_include(<LibWeb/URL/HTMLInputElement.h>)
#    include <LibWeb/URL/HTMLInputElement.h>
#endif
...
HTMLInputElementConstructor::HTMLInputElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLInputElementConstructor::~HTMLInputElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLInputElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLInputElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLInputElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLInputElement");

}

void HTMLInputElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLInputElementPrototype>("HTMLInputElement"), 0);
