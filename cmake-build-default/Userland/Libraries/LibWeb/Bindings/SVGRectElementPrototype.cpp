...
SVGRectElementPrototype::SVGRectElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"))

{
}

SVGRectElementPrototype::~SVGRectElementPrototype()
{
}

void SVGRectElementPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("rx", rx_getter, nullptr, default_attributes);

    define_native_accessor("ry", ry_getter, nullptr, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<SVG::SVGRectElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<SVGRectElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "SVG::SVGRectElement");

    return &static_cast<SVGRectElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(SVGRectElementPrototype::x_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(SVGRectElementPrototype::y_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRectElementPrototype::width_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRectElementPrototype::height_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRectElementPrototype::rx_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->rx(); }));

    return wrap(global_object, const_cast<SVGAnimatedLength&>(*retval));

}

JS_DEFINE_NATIVE_FUNCTION(SVGRectElementPrototype::ry_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->ry(); }));
