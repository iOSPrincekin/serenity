...
IntersectionObserverWrapper* IntersectionObserverWrapper::create(JS::GlobalObject& global_object, IntersectionObserver::IntersectionObserver& impl)
{
    return global_object.heap().allocate<IntersectionObserverWrapper>(global_object, global_object, impl);
}


IntersectionObserverWrapper::IntersectionObserverWrapper(JS::GlobalObject& global_object, IntersectionObserver::IntersectionObserver& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<IntersectionObserverPrototype>("IntersectionObserver"))
    , m_impl(impl)
{
}

void IntersectionObserverWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "IntersectionObserver"), JS::Attribute::Configurable);
}
...
IntersectionObserverWrapper* wrap(JS::GlobalObject& global_object, IntersectionObserver::IntersectionObserver& impl)
{
    return static_cast<IntersectionObserverWrapper*>(wrap_impl(global_object, impl));
}
