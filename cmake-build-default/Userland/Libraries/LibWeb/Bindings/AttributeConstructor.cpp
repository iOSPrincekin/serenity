...
#if __has_include(<LibWeb/Crypto/Attribute.h>)
#    include <LibWeb/Crypto/Attribute.h>
#elif __has_include(<LibWeb/CSS/Attribute.h>)
#    include <LibWeb/CSS/Attribute.h>
#elif __has_include(<LibWeb/DOM/Attribute.h>)
#    include <LibWeb/DOM/Attribute.h>
#elif __has_include(<LibWeb/Encoding/Attribute.h>)
#    include <LibWeb/Encoding/Attribute.h>
#elif __has_include(<LibWeb/Geometry/Attribute.h>)
#    include <LibWeb/Geometry/Attribute.h>
#elif __has_include(<LibWeb/HTML/Attribute.h>)
#    include <LibWeb/HTML/Attribute.h>
#elif __has_include(<LibWeb/UIEvents/Attribute.h>)
#    include <LibWeb/UIEvents/Attribute.h>
#elif __has_include(<LibWeb/HighResolutionTime/Attribute.h>)
#    include <LibWeb/HighResolutionTime/Attribute.h>
#elif __has_include(<LibWeb/IntersectionObserver/Attribute.h>)
#    include <LibWeb/IntersectionObserver/Attribute.h>
#elif __has_include(<LibWeb/NavigationTiming/Attribute.h>)
#    include <LibWeb/NavigationTiming/Attribute.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Attribute.h>)
#    include <LibWeb/RequestIdleCallback/Attribute.h>
#elif __has_include(<LibWeb/ResizeObserver/Attribute.h>)
#    include <LibWeb/ResizeObserver/Attribute.h>
#elif __has_include(<LibWeb/SVG/Attribute.h>)
#    include <LibWeb/SVG/Attribute.h>
#elif __has_include(<LibWeb/Selection/Attribute.h>)
#    include <LibWeb/Selection/Attribute.h>
#elif __has_include(<LibWeb/WebSockets/Attribute.h>)
#    include <LibWeb/WebSockets/Attribute.h>
#elif __has_include(<LibWeb/XHR/Attribute.h>)
#    include <LibWeb/XHR/Attribute.h>
#elif __has_include(<LibWeb/URL/Attribute.h>)
#    include <LibWeb/URL/Attribute.h>
#endif
...
AttributeConstructor::AttributeConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> AttributeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Attribute");
}

JS::ThrowCompletionOr<JS::Object*> AttributeConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "Attribute");

}

void AttributeConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<AttributePrototype>("Attribute"), 0);
