...
#if __has_include(<LibWeb/Crypto/SVGPolygonElement.h>)
#    include <LibWeb/Crypto/SVGPolygonElement.h>
#elif __has_include(<LibWeb/CSS/SVGPolygonElement.h>)
#    include <LibWeb/CSS/SVGPolygonElement.h>
#elif __has_include(<LibWeb/DOM/SVGPolygonElement.h>)
#    include <LibWeb/DOM/SVGPolygonElement.h>
#elif __has_include(<LibWeb/Encoding/SVGPolygonElement.h>)
#    include <LibWeb/Encoding/SVGPolygonElement.h>
#elif __has_include(<LibWeb/Geometry/SVGPolygonElement.h>)
#    include <LibWeb/Geometry/SVGPolygonElement.h>
#elif __has_include(<LibWeb/HTML/SVGPolygonElement.h>)
#    include <LibWeb/HTML/SVGPolygonElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGPolygonElement.h>)
#    include <LibWeb/UIEvents/SVGPolygonElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGPolygonElement.h>)
#    include <LibWeb/HighResolutionTime/SVGPolygonElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGPolygonElement.h>)
#    include <LibWeb/IntersectionObserver/SVGPolygonElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGPolygonElement.h>)
#    include <LibWeb/NavigationTiming/SVGPolygonElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGPolygonElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGPolygonElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGPolygonElement.h>)
#    include <LibWeb/ResizeObserver/SVGPolygonElement.h>
#elif __has_include(<LibWeb/SVG/SVGPolygonElement.h>)
#    include <LibWeb/SVG/SVGPolygonElement.h>
#elif __has_include(<LibWeb/Selection/SVGPolygonElement.h>)
#    include <LibWeb/Selection/SVGPolygonElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGPolygonElement.h>)
#    include <LibWeb/WebSockets/SVGPolygonElement.h>
#elif __has_include(<LibWeb/XHR/SVGPolygonElement.h>)
#    include <LibWeb/XHR/SVGPolygonElement.h>
#elif __has_include(<LibWeb/URL/SVGPolygonElement.h>)
#    include <LibWeb/URL/SVGPolygonElement.h>
#endif
...
SVGPolygonElementConstructor::SVGPolygonElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGPolygonElementConstructor::~SVGPolygonElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGPolygonElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGPolygonElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGPolygonElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGPolygonElement");

}

void SVGPolygonElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGPolygonElementPrototype>("SVGPolygonElement"), 0);
