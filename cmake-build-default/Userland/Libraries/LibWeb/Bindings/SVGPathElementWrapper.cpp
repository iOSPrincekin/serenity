...
SVGPathElementWrapper* SVGPathElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGPathElement& impl)
{
    return global_object.heap().allocate<SVGPathElementWrapper>(global_object, global_object, impl);
}


SVGPathElementWrapper::SVGPathElementWrapper(JS::GlobalObject& global_object, SVG::SVGPathElement& impl)
    : SVGGeometryElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGPathElementPrototype>("SVGPathElement"));
}

void SVGPathElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGeometryElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGPathElement"), JS::Attribute::Configurable);
}

SVGPathElementWrapper::~SVGPathElementWrapper()
{
}
