...
IntersectionObserverPrototype::IntersectionObserverPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

IntersectionObserverPrototype::~IntersectionObserverPrototype()
{
}

void IntersectionObserverPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<IntersectionObserver::IntersectionObserver*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<IntersectionObserverWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "IntersectionObserver::IntersectionObserver");

    return &static_cast<IntersectionObserverWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(IntersectionObserverPrototype::observe)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->observe(target); }));
