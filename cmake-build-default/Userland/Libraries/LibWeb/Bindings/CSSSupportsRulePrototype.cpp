...
CSSSupportsRulePrototype::CSSSupportsRulePrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<CSSConditionRulePrototype>("CSSConditionRule"))

{
}

CSSSupportsRulePrototype::~CSSSupportsRulePrototype()
{
}

void CSSSupportsRulePrototype::initialize(JS::GlobalObject& global_object)
{
