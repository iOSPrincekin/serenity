...
class HTMLCollectionWrapper : public Wrapper {
    JS_OBJECT(HTMLCollection, Wrapper);
public:
    static HTMLCollectionWrapper* create(JS::GlobalObject&, DOM::HTMLCollection&);

    HTMLCollectionWrapper(JS::GlobalObject&, DOM::HTMLCollection&);
    virtual void initialize(JS::GlobalObject&) override;
    virtual ~HTMLCollectionWrapper() override;
    ...
    DOM::HTMLCollection& impl() { return *m_impl; }
    DOM::HTMLCollection const& impl() const { return *m_impl; }
...
private:
    ...
    NonnullRefPtr<DOM::HTMLCollection> m_impl;
