...
SVGSVGElementWrapper* SVGSVGElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGSVGElement& impl)
{
    return global_object.heap().allocate<SVGSVGElementWrapper>(global_object, global_object, impl);
}


SVGSVGElementWrapper::SVGSVGElementWrapper(JS::GlobalObject& global_object, SVG::SVGSVGElement& impl)
    : SVGGraphicsElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGSVGElementPrototype>("SVGSVGElement"));
}

void SVGSVGElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGraphicsElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGSVGElement"), JS::Attribute::Configurable);
}

SVGSVGElementWrapper::~SVGSVGElementWrapper()
{
}
