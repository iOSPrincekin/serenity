...
SVGTextContentElementPrototype::SVGTextContentElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGraphicsElementPrototype>("SVGGraphicsElement"))

{
}

SVGTextContentElementPrototype::~SVGTextContentElementPrototype()
{
}

void SVGTextContentElementPrototype::initialize(JS::GlobalObject& global_object)
{
    [[maybe_unused]] auto& vm = this->vm();
    [[maybe_unused]] u8 default_attributes = JS::Attribute::Enumerable | JS::Attribute::Configurable | JS::Attribute::Writable;


    define_native_function("getNumberOfChars", get_number_of_chars, 0, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<SVG::SVGTextContentElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<SVGTextContentElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "SVG::SVGTextContentElement");

    return &static_cast<SVGTextContentElementWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(SVGTextContentElementPrototype::get_number_of_chars)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->get_number_of_chars(); }));
