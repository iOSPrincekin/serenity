...
#if __has_include(<LibWeb/Crypto/NodeIterator.h>)
#    include <LibWeb/Crypto/NodeIterator.h>
#elif __has_include(<LibWeb/CSS/NodeIterator.h>)
#    include <LibWeb/CSS/NodeIterator.h>
#elif __has_include(<LibWeb/DOM/NodeIterator.h>)
#    include <LibWeb/DOM/NodeIterator.h>
#elif __has_include(<LibWeb/Encoding/NodeIterator.h>)
#    include <LibWeb/Encoding/NodeIterator.h>
#elif __has_include(<LibWeb/Geometry/NodeIterator.h>)
#    include <LibWeb/Geometry/NodeIterator.h>
#elif __has_include(<LibWeb/HTML/NodeIterator.h>)
#    include <LibWeb/HTML/NodeIterator.h>
#elif __has_include(<LibWeb/UIEvents/NodeIterator.h>)
#    include <LibWeb/UIEvents/NodeIterator.h>
#elif __has_include(<LibWeb/HighResolutionTime/NodeIterator.h>)
#    include <LibWeb/HighResolutionTime/NodeIterator.h>
#elif __has_include(<LibWeb/IntersectionObserver/NodeIterator.h>)
#    include <LibWeb/IntersectionObserver/NodeIterator.h>
#elif __has_include(<LibWeb/NavigationTiming/NodeIterator.h>)
#    include <LibWeb/NavigationTiming/NodeIterator.h>
#elif __has_include(<LibWeb/RequestIdleCallback/NodeIterator.h>)
#    include <LibWeb/RequestIdleCallback/NodeIterator.h>
#elif __has_include(<LibWeb/ResizeObserver/NodeIterator.h>)
#    include <LibWeb/ResizeObserver/NodeIterator.h>
#elif __has_include(<LibWeb/SVG/NodeIterator.h>)
#    include <LibWeb/SVG/NodeIterator.h>
#elif __has_include(<LibWeb/Selection/NodeIterator.h>)
#    include <LibWeb/Selection/NodeIterator.h>
#elif __has_include(<LibWeb/WebSockets/NodeIterator.h>)
#    include <LibWeb/WebSockets/NodeIterator.h>
#elif __has_include(<LibWeb/XHR/NodeIterator.h>)
#    include <LibWeb/XHR/NodeIterator.h>
#elif __has_include(<LibWeb/URL/NodeIterator.h>)
#    include <LibWeb/URL/NodeIterator.h>
#endif
...
NodeIteratorConstructor::NodeIteratorConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

NodeIteratorConstructor::~NodeIteratorConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> NodeIteratorConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "NodeIterator");
}

JS::ThrowCompletionOr<JS::Object*> NodeIteratorConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "NodeIterator");

}

void NodeIteratorConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<NodeIteratorPrototype>("NodeIterator"), 0);
