...
HTMLMarqueeElementPrototype::HTMLMarqueeElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void HTMLMarqueeElementPrototype::initialize(JS::GlobalObject& global_object)
{
    [[maybe_unused]] auto& vm = this->vm();
    [[maybe_unused]] u8 default_attributes = JS::Attribute::Enumerable | JS::Attribute::Configurable | JS::Attribute::Writable;


    define_native_accessor("behavior", behavior_getter, behavior_setter, default_attributes);

    define_native_accessor("bgColor", bg_color_getter, bg_color_setter, default_attributes);

    define_native_accessor("direction", direction_getter, direction_setter, default_attributes);
...
static JS::ThrowCompletionOr<HTML::HTMLMarqueeElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLMarqueeElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLMarqueeElement");

    return &static_cast<HTMLMarqueeElementWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMarqueeElementPrototype::behavior_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::behavior);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMarqueeElementPrototype::behavior_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::behavior, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMarqueeElementPrototype::direction_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::direction);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMarqueeElementPrototype::direction_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::direction, cpp_value);
