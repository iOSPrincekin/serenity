...
SVGPolygonElementPrototype::SVGPolygonElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"))

{
}

SVGPolygonElementPrototype::~SVGPolygonElementPrototype()
{
}

void SVGPolygonElementPrototype::initialize(JS::GlobalObject& global_object)
{
