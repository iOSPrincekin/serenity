...
HTMLPictureElementPrototype::HTMLPictureElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLPictureElementPrototype::~HTMLPictureElementPrototype()
{
}

void HTMLPictureElementPrototype::initialize(JS::GlobalObject& global_object)
{
