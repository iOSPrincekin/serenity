...
HTMLTableCaptionElementPrototype::HTMLTableCaptionElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLTableCaptionElementPrototype::~HTMLTableCaptionElementPrototype()
{
}

void HTMLTableCaptionElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLTableCaptionElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLTableCaptionElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLTableCaptionElement");

    return &static_cast<HTMLTableCaptionElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableCaptionElementPrototype::align_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableCaptionElementPrototype::align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
