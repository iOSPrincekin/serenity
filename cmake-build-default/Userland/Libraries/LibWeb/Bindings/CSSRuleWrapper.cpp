...
CSSRuleWrapper* CSSRuleWrapper::create(JS::GlobalObject& global_object, CSS::CSSRule& impl)
{
    return global_object.heap().allocate<CSSRuleWrapper>(global_object, global_object, impl);
}


CSSRuleWrapper::CSSRuleWrapper(JS::GlobalObject& global_object, CSS::CSSRule& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<CSSRulePrototype>("CSSRule"))
    , m_impl(impl)
{
}

void CSSRuleWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "CSSRule"), JS::Attribute::Configurable);
}
