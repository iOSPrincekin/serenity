...
HTMLLIElementPrototype::HTMLLIElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLLIElementPrototype::~HTMLLIElementPrototype()
{
}

void HTMLLIElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLLIElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLLIElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLLIElement");

    return &static_cast<HTMLLIElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLLIElementPrototype::type_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLLIElementPrototype::type_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
