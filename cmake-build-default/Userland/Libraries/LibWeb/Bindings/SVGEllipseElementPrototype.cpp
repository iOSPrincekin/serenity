...
SVGEllipseElementPrototype::SVGEllipseElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"))

{
}

SVGEllipseElementPrototype::~SVGEllipseElementPrototype()
{
}

void SVGEllipseElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<SVG::SVGEllipseElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<SVGEllipseElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "SVG::SVGEllipseElement");

    return &static_cast<SVGEllipseElementWrapper*>(this_object)->impl();
}
