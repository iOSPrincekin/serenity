...
HTMLLegendElementPrototype::HTMLLegendElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLLegendElementPrototype::~HTMLLegendElementPrototype()
{
}

void HTMLLegendElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLLegendElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLLegendElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLLegendElement");

    return &static_cast<HTMLLegendElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLLegendElementPrototype::align_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLLegendElementPrototype::align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
