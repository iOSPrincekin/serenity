...
HTMLTemplateElementWrapper* HTMLTemplateElementWrapper::create(JS::GlobalObject& global_object, HTML::HTMLTemplateElement& impl)
{
    return global_object.heap().allocate<HTMLTemplateElementWrapper>(global_object, global_object, impl);
}


HTMLTemplateElementWrapper::HTMLTemplateElementWrapper(JS::GlobalObject& global_object, HTML::HTMLTemplateElement& impl)
    : HTMLElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLTemplateElementPrototype>("HTMLTemplateElement"));
}

void HTMLTemplateElementWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLTemplateElement"), JS::Attribute::Configurable);
}

HTMLTemplateElementWrapper::~HTMLTemplateElementWrapper()
{
}
