...
CharacterDataWrapper* CharacterDataWrapper::create(JS::GlobalObject& global_object, DOM::CharacterData& impl)
{
    return global_object.heap().allocate<CharacterDataWrapper>(global_object, global_object, impl);
}


CharacterDataWrapper::CharacterDataWrapper(JS::GlobalObject& global_object, DOM::CharacterData& impl)
    : NodeWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<CharacterDataPrototype>("CharacterData"));
}

void CharacterDataWrapper::initialize(JS::GlobalObject& global_object)
{
    NodeWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "CharacterData"), JS::Attribute::Configurable);
}
...
CharacterDataWrapper* wrap(JS::GlobalObject& global_object, DOM::CharacterData& impl)
{
    return static_cast<CharacterDataWrapper*>(wrap_impl(global_object, impl));
}
