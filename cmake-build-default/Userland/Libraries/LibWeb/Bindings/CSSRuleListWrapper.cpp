...
CSSRuleListWrapper* CSSRuleListWrapper::create(JS::GlobalObject& global_object, CSS::CSSRuleList& impl)
{
    return global_object.heap().allocate<CSSRuleListWrapper>(global_object, global_object, impl);
}


CSSRuleListWrapper::CSSRuleListWrapper(JS::GlobalObject& global_object, CSS::CSSRuleList& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<CSSRuleListPrototype>("CSSRuleList"))
    , m_impl(impl)
{
}

void CSSRuleListWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "CSSRuleList"), JS::Attribute::Configurable);
}

CSSRuleListWrapper::~CSSRuleListWrapper()
{
}

CSSRuleListWrapper* wrap(JS::GlobalObject& global_object, CSS::CSSRuleList& impl)
{
    return static_cast<CSSRuleListWrapper*>(wrap_impl(global_object, impl));
}
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> CSSRuleListWrapper::legacy_platform_object_get_own_property_for_get_own_property_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> CSSRuleListWrapper::legacy_platform_object_get_own_property_for_set_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> CSSRuleListWrapper::internal_get_own_property(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<bool> CSSRuleListWrapper::internal_set(JS::PropertyKey const& property_name, JS::Value value, JS::Value receiver)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> CSSRuleListWrapper::internal_define_own_property(JS::PropertyKey const& property_name, JS::PropertyDescriptor const& property_descriptor)
{
...
JS::ThrowCompletionOr<bool> CSSRuleListWrapper::internal_delete(JS::PropertyKey const& property_name)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> CSSRuleListWrapper::internal_prevent_extensions()
{
    // 1. Return false.
    return false;
}

JS::ThrowCompletionOr<JS::MarkedVector<JS::Value>> CSSRuleListWrapper::internal_own_property_keys() const
{
    auto& vm = this->vm();
