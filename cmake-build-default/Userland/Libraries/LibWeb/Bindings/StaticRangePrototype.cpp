...
StaticRangePrototype::StaticRangePrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<AbstractRangePrototype>("AbstractRange"))

{
}

StaticRangePrototype::~StaticRangePrototype()
{
}

void StaticRangePrototype::initialize(JS::GlobalObject& global_object)
{
