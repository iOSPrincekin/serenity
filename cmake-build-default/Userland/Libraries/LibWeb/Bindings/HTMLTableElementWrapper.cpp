...
HTMLTableElementWrapper* HTMLTableElementWrapper::create(JS::GlobalObject& global_object, HTML::HTMLTableElement& impl)
{
    return global_object.heap().allocate<HTMLTableElementWrapper>(global_object, global_object, impl);
}


HTMLTableElementWrapper::HTMLTableElementWrapper(JS::GlobalObject& global_object, HTML::HTMLTableElement& impl)
    : HTMLElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLTableElementPrototype>("HTMLTableElement"));
}

void HTMLTableElementWrapper::initialize(JS::GlobalObject& global_object)
{
    HTMLElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "HTMLTableElement"), JS::Attribute::Configurable);
}

HTMLTableElementWrapper::~HTMLTableElementWrapper()
{
}
