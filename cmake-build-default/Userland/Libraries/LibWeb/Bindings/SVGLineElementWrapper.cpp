...
SVGLineElementWrapper* SVGLineElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGLineElement& impl)
{
    return global_object.heap().allocate<SVGLineElementWrapper>(global_object, global_object, impl);
}


SVGLineElementWrapper::SVGLineElementWrapper(JS::GlobalObject& global_object, SVG::SVGLineElement& impl)
    : SVGGeometryElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGLineElementPrototype>("SVGLineElement"));
}

void SVGLineElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGeometryElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGLineElement"), JS::Attribute::Configurable);
}

SVGLineElementWrapper::~SVGLineElementWrapper()
{
}
