...
SVGElementPrototype::SVGElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void SVGElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<SVG::SVGElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<SVGElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "SVG::SVGElement");

    return &static_cast<SVGElementWrapper*>(this_object)->impl();
}
