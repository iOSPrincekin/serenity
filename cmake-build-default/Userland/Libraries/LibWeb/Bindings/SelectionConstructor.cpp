...
#if __has_include(<LibWeb/Crypto/Selection.h>)
#    include <LibWeb/Crypto/Selection.h>
#elif __has_include(<LibWeb/CSS/Selection.h>)
#    include <LibWeb/CSS/Selection.h>
#elif __has_include(<LibWeb/DOM/Selection.h>)
#    include <LibWeb/DOM/Selection.h>
#elif __has_include(<LibWeb/Encoding/Selection.h>)
#    include <LibWeb/Encoding/Selection.h>
#elif __has_include(<LibWeb/Geometry/Selection.h>)
#    include <LibWeb/Geometry/Selection.h>
#elif __has_include(<LibWeb/HTML/Selection.h>)
#    include <LibWeb/HTML/Selection.h>
#elif __has_include(<LibWeb/UIEvents/Selection.h>)
#    include <LibWeb/UIEvents/Selection.h>
#elif __has_include(<LibWeb/HighResolutionTime/Selection.h>)
#    include <LibWeb/HighResolutionTime/Selection.h>
#elif __has_include(<LibWeb/IntersectionObserver/Selection.h>)
#    include <LibWeb/IntersectionObserver/Selection.h>
#elif __has_include(<LibWeb/NavigationTiming/Selection.h>)
#    include <LibWeb/NavigationTiming/Selection.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Selection.h>)
#    include <LibWeb/RequestIdleCallback/Selection.h>
#elif __has_include(<LibWeb/ResizeObserver/Selection.h>)
#    include <LibWeb/ResizeObserver/Selection.h>
#elif __has_include(<LibWeb/SVG/Selection.h>)
#    include <LibWeb/SVG/Selection.h>
#elif __has_include(<LibWeb/Selection/Selection.h>)
#    include <LibWeb/Selection/Selection.h>
#elif __has_include(<LibWeb/WebSockets/Selection.h>)
#    include <LibWeb/WebSockets/Selection.h>
#elif __has_include(<LibWeb/XHR/Selection.h>)
#    include <LibWeb/XHR/Selection.h>
#elif __has_include(<LibWeb/URL/Selection.h>)
#    include <LibWeb/URL/Selection.h>
#endif
...
SelectionConstructor::SelectionConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> SelectionConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Selection");
}

JS::ThrowCompletionOr<JS::Object*> SelectionConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "Selection");

}

void SelectionConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SelectionPrototype>("Selection"), 0);
