...
#include <LibWeb/Bindings/StaticRangeWrapper.h>
...
#if __has_include(<LibWeb/Bindings/StaticRangeWrapper.h>)
#   include <LibWeb/Bindings/StaticRangeWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/StaticRangeWrapperFactory.h>)
#   include <LibWeb/Bindings/StaticRangeWrapperFactory.h>
#endif
...
StaticRangeWrapper* StaticRangeWrapper::create(JS::GlobalObject& global_object, DOM::StaticRange& impl)
{
    return global_object.heap().allocate<StaticRangeWrapper>(global_object, global_object, impl);
}


StaticRangeWrapper::StaticRangeWrapper(JS::GlobalObject& global_object, DOM::StaticRange& impl)
    : AbstractRangeWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<StaticRangePrototype>("StaticRange"));
}

void StaticRangeWrapper::initialize(JS::GlobalObject& global_object)
{
    AbstractRangeWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "StaticRange"), JS::Attribute::Configurable);
}

StaticRangeWrapper::~StaticRangeWrapper()
{
}

StaticRangeWrapper* wrap(JS::GlobalObject& global_object, DOM::StaticRange& impl)
{
    return static_cast<StaticRangeWrapper*>(wrap_impl(global_object, impl));
}
