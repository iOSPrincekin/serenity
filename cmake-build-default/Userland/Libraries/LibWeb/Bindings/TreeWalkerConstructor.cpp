...
#if __has_include(<LibWeb/Crypto/TreeWalker.h>)
#    include <LibWeb/Crypto/TreeWalker.h>
#elif __has_include(<LibWeb/CSS/TreeWalker.h>)
#    include <LibWeb/CSS/TreeWalker.h>
#elif __has_include(<LibWeb/DOM/TreeWalker.h>)
#    include <LibWeb/DOM/TreeWalker.h>
#elif __has_include(<LibWeb/Encoding/TreeWalker.h>)
#    include <LibWeb/Encoding/TreeWalker.h>
#elif __has_include(<LibWeb/Geometry/TreeWalker.h>)
#    include <LibWeb/Geometry/TreeWalker.h>
#elif __has_include(<LibWeb/HTML/TreeWalker.h>)
#    include <LibWeb/HTML/TreeWalker.h>
#elif __has_include(<LibWeb/UIEvents/TreeWalker.h>)
#    include <LibWeb/UIEvents/TreeWalker.h>
#elif __has_include(<LibWeb/HighResolutionTime/TreeWalker.h>)
#    include <LibWeb/HighResolutionTime/TreeWalker.h>
#elif __has_include(<LibWeb/IntersectionObserver/TreeWalker.h>)
#    include <LibWeb/IntersectionObserver/TreeWalker.h>
#elif __has_include(<LibWeb/NavigationTiming/TreeWalker.h>)
#    include <LibWeb/NavigationTiming/TreeWalker.h>
#elif __has_include(<LibWeb/RequestIdleCallback/TreeWalker.h>)
#    include <LibWeb/RequestIdleCallback/TreeWalker.h>
#elif __has_include(<LibWeb/ResizeObserver/TreeWalker.h>)
#    include <LibWeb/ResizeObserver/TreeWalker.h>
#elif __has_include(<LibWeb/SVG/TreeWalker.h>)
#    include <LibWeb/SVG/TreeWalker.h>
#elif __has_include(<LibWeb/Selection/TreeWalker.h>)
#    include <LibWeb/Selection/TreeWalker.h>
#elif __has_include(<LibWeb/WebSockets/TreeWalker.h>)
#    include <LibWeb/WebSockets/TreeWalker.h>
#elif __has_include(<LibWeb/XHR/TreeWalker.h>)
#    include <LibWeb/XHR/TreeWalker.h>
#elif __has_include(<LibWeb/URL/TreeWalker.h>)
#    include <LibWeb/URL/TreeWalker.h>
#endif
...
TreeWalkerConstructor::TreeWalkerConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

TreeWalkerConstructor::~TreeWalkerConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> TreeWalkerConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "TreeWalker");
}

JS::ThrowCompletionOr<JS::Object*> TreeWalkerConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "TreeWalker");

}

void TreeWalkerConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<TreeWalkerPrototype>("TreeWalker"), 0);
