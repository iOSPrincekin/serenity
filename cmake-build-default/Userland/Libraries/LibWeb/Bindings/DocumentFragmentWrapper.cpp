...
DocumentFragmentWrapper* DocumentFragmentWrapper::create(JS::GlobalObject& global_object, DOM::DocumentFragment& impl)
{
    return global_object.heap().allocate<DocumentFragmentWrapper>(global_object, global_object, impl);
}


DocumentFragmentWrapper::DocumentFragmentWrapper(JS::GlobalObject& global_object, DOM::DocumentFragment& impl)
    : NodeWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<DocumentFragmentPrototype>("DocumentFragment"));
}

void DocumentFragmentWrapper::initialize(JS::GlobalObject& global_object)
{
    NodeWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "DocumentFragment"), JS::Attribute::Configurable);
}

DocumentFragmentWrapper::~DocumentFragmentWrapper()
{
}

DocumentFragmentWrapper* wrap(JS::GlobalObject& global_object, DOM::DocumentFragment& impl)
{
    return static_cast<DocumentFragmentWrapper*>(wrap_impl(global_object, impl));
}
