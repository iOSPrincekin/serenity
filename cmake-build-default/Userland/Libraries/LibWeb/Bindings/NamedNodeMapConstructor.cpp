...
#if __has_include(<LibWeb/Crypto/NamedNodeMap.h>)
#    include <LibWeb/Crypto/NamedNodeMap.h>
#elif __has_include(<LibWeb/CSS/NamedNodeMap.h>)
#    include <LibWeb/CSS/NamedNodeMap.h>
#elif __has_include(<LibWeb/DOM/NamedNodeMap.h>)
#    include <LibWeb/DOM/NamedNodeMap.h>
#elif __has_include(<LibWeb/Encoding/NamedNodeMap.h>)
#    include <LibWeb/Encoding/NamedNodeMap.h>
#elif __has_include(<LibWeb/Geometry/NamedNodeMap.h>)
#    include <LibWeb/Geometry/NamedNodeMap.h>
#elif __has_include(<LibWeb/HTML/NamedNodeMap.h>)
#    include <LibWeb/HTML/NamedNodeMap.h>
#elif __has_include(<LibWeb/UIEvents/NamedNodeMap.h>)
#    include <LibWeb/UIEvents/NamedNodeMap.h>
#elif __has_include(<LibWeb/HighResolutionTime/NamedNodeMap.h>)
#    include <LibWeb/HighResolutionTime/NamedNodeMap.h>
#elif __has_include(<LibWeb/IntersectionObserver/NamedNodeMap.h>)
#    include <LibWeb/IntersectionObserver/NamedNodeMap.h>
#elif __has_include(<LibWeb/NavigationTiming/NamedNodeMap.h>)
#    include <LibWeb/NavigationTiming/NamedNodeMap.h>
#elif __has_include(<LibWeb/RequestIdleCallback/NamedNodeMap.h>)
#    include <LibWeb/RequestIdleCallback/NamedNodeMap.h>
#elif __has_include(<LibWeb/ResizeObserver/NamedNodeMap.h>)
#    include <LibWeb/ResizeObserver/NamedNodeMap.h>
#elif __has_include(<LibWeb/SVG/NamedNodeMap.h>)
#    include <LibWeb/SVG/NamedNodeMap.h>
#elif __has_include(<LibWeb/Selection/NamedNodeMap.h>)
#    include <LibWeb/Selection/NamedNodeMap.h>
#elif __has_include(<LibWeb/WebSockets/NamedNodeMap.h>)
#    include <LibWeb/WebSockets/NamedNodeMap.h>
#elif __has_include(<LibWeb/XHR/NamedNodeMap.h>)
#    include <LibWeb/XHR/NamedNodeMap.h>
#elif __has_include(<LibWeb/URL/NamedNodeMap.h>)
#    include <LibWeb/URL/NamedNodeMap.h>
#endif
...
NamedNodeMapConstructor::NamedNodeMapConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

NamedNodeMapConstructor::~NamedNodeMapConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> NamedNodeMapConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "NamedNodeMap");
}

JS::ThrowCompletionOr<JS::Object*> NamedNodeMapConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "NamedNodeMap");

}

void NamedNodeMapConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<NamedNodeMapPrototype>("NamedNodeMap"), 0);
