...
HTMLCollectionPrototype::HTMLCollectionPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

HTMLCollectionPrototype::~HTMLCollectionPrototype()
{
}

void HTMLCollectionPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_function("namedItem", named_item, 1, default_attributes);
...
static JS::ThrowCompletionOr<DOM::HTMLCollection*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLCollectionWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::HTMLCollection");

    return &static_cast<HTMLCollectionWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLCollectionPrototype::length_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLCollectionPrototype::item)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLCollectionPrototype::named_item)
{

    auto* impl = TRY(impl_from(vm, global_object));

    if (vm.argument_count() < 1)
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::BadArgCountOne, "namedItem");
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->named_item(name); }));
