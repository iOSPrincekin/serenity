...
ResizeObserverWrapper* ResizeObserverWrapper::create(JS::GlobalObject& global_object, ResizeObserver::ResizeObserver& impl)
{
    return global_object.heap().allocate<ResizeObserverWrapper>(global_object, global_object, impl);
}


ResizeObserverWrapper::ResizeObserverWrapper(JS::GlobalObject& global_object, ResizeObserver::ResizeObserver& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<ResizeObserverPrototype>("ResizeObserver"))
    , m_impl(impl)
{
}

void ResizeObserverWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "ResizeObserver"), JS::Attribute::Configurable);
}

ResizeObserverWrapper::~ResizeObserverWrapper()
{
}

ResizeObserverWrapper* wrap(JS::GlobalObject& global_object, ResizeObserver::ResizeObserver& impl)
{
    return static_cast<ResizeObserverWrapper*>(wrap_impl(global_object, impl));
}
