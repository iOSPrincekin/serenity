...
#if __has_include(<LibWeb/Crypto/SVGGraphicsElement.h>)
#    include <LibWeb/Crypto/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/CSS/SVGGraphicsElement.h>)
#    include <LibWeb/CSS/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/DOM/SVGGraphicsElement.h>)
#    include <LibWeb/DOM/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/Encoding/SVGGraphicsElement.h>)
#    include <LibWeb/Encoding/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/Geometry/SVGGraphicsElement.h>)
#    include <LibWeb/Geometry/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/HTML/SVGGraphicsElement.h>)
#    include <LibWeb/HTML/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGGraphicsElement.h>)
#    include <LibWeb/UIEvents/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGGraphicsElement.h>)
#    include <LibWeb/HighResolutionTime/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGGraphicsElement.h>)
#    include <LibWeb/IntersectionObserver/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGGraphicsElement.h>)
#    include <LibWeb/NavigationTiming/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGGraphicsElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGGraphicsElement.h>)
#    include <LibWeb/ResizeObserver/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/SVG/SVGGraphicsElement.h>)
#    include <LibWeb/SVG/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/Selection/SVGGraphicsElement.h>)
#    include <LibWeb/Selection/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGGraphicsElement.h>)
#    include <LibWeb/WebSockets/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/XHR/SVGGraphicsElement.h>)
#    include <LibWeb/XHR/SVGGraphicsElement.h>
#elif __has_include(<LibWeb/URL/SVGGraphicsElement.h>)
#    include <LibWeb/URL/SVGGraphicsElement.h>
#endif
...
SVGGraphicsElementConstructor::SVGGraphicsElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGGraphicsElementConstructor::~SVGGraphicsElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGGraphicsElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGGraphicsElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGGraphicsElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGGraphicsElement");

}

void SVGGraphicsElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGGraphicsElementPrototype>("SVGGraphicsElement"), 0);
