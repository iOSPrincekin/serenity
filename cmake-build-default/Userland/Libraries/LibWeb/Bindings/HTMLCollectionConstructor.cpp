...
#if __has_include(<LibWeb/Crypto/HTMLCollection.h>)
#    include <LibWeb/Crypto/HTMLCollection.h>
#elif __has_include(<LibWeb/CSS/HTMLCollection.h>)
#    include <LibWeb/CSS/HTMLCollection.h>
#elif __has_include(<LibWeb/DOM/HTMLCollection.h>)
#    include <LibWeb/DOM/HTMLCollection.h>
#elif __has_include(<LibWeb/Encoding/HTMLCollection.h>)
#    include <LibWeb/Encoding/HTMLCollection.h>
#elif __has_include(<LibWeb/Geometry/HTMLCollection.h>)
#    include <LibWeb/Geometry/HTMLCollection.h>
#elif __has_include(<LibWeb/HTML/HTMLCollection.h>)
#    include <LibWeb/HTML/HTMLCollection.h>
#elif __has_include(<LibWeb/UIEvents/HTMLCollection.h>)
#    include <LibWeb/UIEvents/HTMLCollection.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLCollection.h>)
#    include <LibWeb/HighResolutionTime/HTMLCollection.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLCollection.h>)
#    include <LibWeb/IntersectionObserver/HTMLCollection.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLCollection.h>)
#    include <LibWeb/NavigationTiming/HTMLCollection.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLCollection.h>)
#    include <LibWeb/RequestIdleCallback/HTMLCollection.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLCollection.h>)
#    include <LibWeb/ResizeObserver/HTMLCollection.h>
#elif __has_include(<LibWeb/SVG/HTMLCollection.h>)
#    include <LibWeb/SVG/HTMLCollection.h>
#elif __has_include(<LibWeb/Selection/HTMLCollection.h>)
#    include <LibWeb/Selection/HTMLCollection.h>
#elif __has_include(<LibWeb/WebSockets/HTMLCollection.h>)
#    include <LibWeb/WebSockets/HTMLCollection.h>
#elif __has_include(<LibWeb/XHR/HTMLCollection.h>)
#    include <LibWeb/XHR/HTMLCollection.h>
#elif __has_include(<LibWeb/URL/HTMLCollection.h>)
#    include <LibWeb/URL/HTMLCollection.h>
#endif
...
HTMLCollectionConstructor::HTMLCollectionConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLCollectionConstructor::~HTMLCollectionConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLCollectionConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLCollection");
}

JS::ThrowCompletionOr<JS::Object*> HTMLCollectionConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLCollection");

}

void HTMLCollectionConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLCollectionPrototype>("HTMLCollection"), 0);
