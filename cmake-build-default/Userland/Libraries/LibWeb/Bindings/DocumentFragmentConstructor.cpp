...
#if __has_include(<LibWeb/Crypto/DocumentFragment.h>)
#    include <LibWeb/Crypto/DocumentFragment.h>
#elif __has_include(<LibWeb/CSS/DocumentFragment.h>)
#    include <LibWeb/CSS/DocumentFragment.h>
#elif __has_include(<LibWeb/DOM/DocumentFragment.h>)
#    include <LibWeb/DOM/DocumentFragment.h>
#elif __has_include(<LibWeb/Encoding/DocumentFragment.h>)
#    include <LibWeb/Encoding/DocumentFragment.h>
#elif __has_include(<LibWeb/Geometry/DocumentFragment.h>)
#    include <LibWeb/Geometry/DocumentFragment.h>
#elif __has_include(<LibWeb/HTML/DocumentFragment.h>)
#    include <LibWeb/HTML/DocumentFragment.h>
#elif __has_include(<LibWeb/UIEvents/DocumentFragment.h>)
#    include <LibWeb/UIEvents/DocumentFragment.h>
#elif __has_include(<LibWeb/HighResolutionTime/DocumentFragment.h>)
#    include <LibWeb/HighResolutionTime/DocumentFragment.h>
#elif __has_include(<LibWeb/IntersectionObserver/DocumentFragment.h>)
#    include <LibWeb/IntersectionObserver/DocumentFragment.h>
#elif __has_include(<LibWeb/NavigationTiming/DocumentFragment.h>)
#    include <LibWeb/NavigationTiming/DocumentFragment.h>
#elif __has_include(<LibWeb/RequestIdleCallback/DocumentFragment.h>)
#    include <LibWeb/RequestIdleCallback/DocumentFragment.h>
#elif __has_include(<LibWeb/ResizeObserver/DocumentFragment.h>)
#    include <LibWeb/ResizeObserver/DocumentFragment.h>
#elif __has_include(<LibWeb/SVG/DocumentFragment.h>)
#    include <LibWeb/SVG/DocumentFragment.h>
#elif __has_include(<LibWeb/Selection/DocumentFragment.h>)
#    include <LibWeb/Selection/DocumentFragment.h>
#elif __has_include(<LibWeb/WebSockets/DocumentFragment.h>)
#    include <LibWeb/WebSockets/DocumentFragment.h>
#elif __has_include(<LibWeb/XHR/DocumentFragment.h>)
#    include <LibWeb/XHR/DocumentFragment.h>
#elif __has_include(<LibWeb/URL/DocumentFragment.h>)
#    include <LibWeb/URL/DocumentFragment.h>
#endif
...
DocumentFragmentConstructor::DocumentFragmentConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

DocumentFragmentConstructor::~DocumentFragmentConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DocumentFragmentConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "DocumentFragment");
}

JS::ThrowCompletionOr<JS::Object*> DocumentFragmentConstructor::construct(FunctionObject&)
{
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return DOM::DocumentFragment::create_with_global_object(window); }));

    return wrap(global_object, *impl);

}

void DocumentFragmentConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    auto& window = static_cast<WindowObject&>(global_object);
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<DocumentFragmentPrototype>("DocumentFragment"), 0);
