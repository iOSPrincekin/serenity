...
#if __has_include(<LibWeb/Crypto/SVGSVGElement.h>)
#    include <LibWeb/Crypto/SVGSVGElement.h>
#elif __has_include(<LibWeb/CSS/SVGSVGElement.h>)
#    include <LibWeb/CSS/SVGSVGElement.h>
#elif __has_include(<LibWeb/DOM/SVGSVGElement.h>)
#    include <LibWeb/DOM/SVGSVGElement.h>
#elif __has_include(<LibWeb/Encoding/SVGSVGElement.h>)
#    include <LibWeb/Encoding/SVGSVGElement.h>
#elif __has_include(<LibWeb/Geometry/SVGSVGElement.h>)
#    include <LibWeb/Geometry/SVGSVGElement.h>
#elif __has_include(<LibWeb/HTML/SVGSVGElement.h>)
#    include <LibWeb/HTML/SVGSVGElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGSVGElement.h>)
#    include <LibWeb/UIEvents/SVGSVGElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGSVGElement.h>)
#    include <LibWeb/HighResolutionTime/SVGSVGElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGSVGElement.h>)
#    include <LibWeb/IntersectionObserver/SVGSVGElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGSVGElement.h>)
#    include <LibWeb/NavigationTiming/SVGSVGElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGSVGElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGSVGElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGSVGElement.h>)
#    include <LibWeb/ResizeObserver/SVGSVGElement.h>
#elif __has_include(<LibWeb/SVG/SVGSVGElement.h>)
#    include <LibWeb/SVG/SVGSVGElement.h>
#elif __has_include(<LibWeb/Selection/SVGSVGElement.h>)
#    include <LibWeb/Selection/SVGSVGElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGSVGElement.h>)
#    include <LibWeb/WebSockets/SVGSVGElement.h>
#elif __has_include(<LibWeb/XHR/SVGSVGElement.h>)
#    include <LibWeb/XHR/SVGSVGElement.h>
#elif __has_include(<LibWeb/URL/SVGSVGElement.h>)
#    include <LibWeb/URL/SVGSVGElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/SVGSVGElementWrapper.h>)
#   include <LibWeb/Bindings/SVGSVGElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/SVGSVGElementWrapperFactory.h>)
#   include <LibWeb/Bindings/SVGSVGElementWrapperFactory.h>
#endif
...
SVGSVGElementConstructor::SVGSVGElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGSVGElementConstructor::~SVGSVGElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGSVGElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGSVGElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGSVGElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGSVGElement");

}

void SVGSVGElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGSVGElementPrototype>("SVGSVGElement"), 0);
