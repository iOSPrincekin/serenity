...
HTMLDataElementPrototype::HTMLDataElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLDataElementPrototype::~HTMLDataElementPrototype()
{
}

void HTMLDataElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLDataElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLDataElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLDataElement");

    return &static_cast<HTMLDataElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDataElementPrototype::value_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDataElementPrototype::value_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
