...
#if __has_include(<LibWeb/Crypto/HTMLTableRowElement.h>)
#    include <LibWeb/Crypto/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/CSS/HTMLTableRowElement.h>)
#    include <LibWeb/CSS/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/DOM/HTMLTableRowElement.h>)
#    include <LibWeb/DOM/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLTableRowElement.h>)
#    include <LibWeb/Encoding/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLTableRowElement.h>)
#    include <LibWeb/Geometry/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/HTML/HTMLTableRowElement.h>)
#    include <LibWeb/HTML/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLTableRowElement.h>)
#    include <LibWeb/UIEvents/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLTableRowElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLTableRowElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLTableRowElement.h>)
#    include <LibWeb/NavigationTiming/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLTableRowElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLTableRowElement.h>)
#    include <LibWeb/ResizeObserver/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/SVG/HTMLTableRowElement.h>)
#    include <LibWeb/SVG/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/Selection/HTMLTableRowElement.h>)
#    include <LibWeb/Selection/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLTableRowElement.h>)
#    include <LibWeb/WebSockets/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/XHR/HTMLTableRowElement.h>)
#    include <LibWeb/XHR/HTMLTableRowElement.h>
#elif __has_include(<LibWeb/URL/HTMLTableRowElement.h>)
#    include <LibWeb/URL/HTMLTableRowElement.h>
#endif
...
HTMLTableRowElementConstructor::HTMLTableRowElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLTableRowElementConstructor::~HTMLTableRowElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLTableRowElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLTableRowElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLTableRowElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLTableRowElement");

}

void HTMLTableRowElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLTableRowElementPrototype>("HTMLTableRowElement"), 0);
