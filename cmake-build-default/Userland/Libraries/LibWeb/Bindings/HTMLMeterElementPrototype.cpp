...
HTMLMeterElementPrototype::HTMLMeterElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLMeterElementPrototype::~HTMLMeterElementPrototype()
{
}

void HTMLMeterElementPrototype::initialize(JS::GlobalObject& global_object)
{
