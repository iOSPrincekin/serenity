...
#if __has_include(<LibWeb/Bindings/HTMLCollectionPrototype.h>)
...
HTMLOptionsCollectionPrototype::HTMLOptionsCollectionPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLCollectionPrototype>("HTMLCollection"))

{
}

HTMLOptionsCollectionPrototype::~HTMLOptionsCollectionPrototype()
{
}

void HTMLOptionsCollectionPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLOptionsCollection*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLOptionsCollectionWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLOptionsCollection");

    return &static_cast<HTMLOptionsCollectionWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLOptionsCollectionPrototype::add)
{
