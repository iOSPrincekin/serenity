...
#if __has_include(<LibWeb/Crypto/HTMLTableElement.h>)
#    include <LibWeb/Crypto/HTMLTableElement.h>
#elif __has_include(<LibWeb/CSS/HTMLTableElement.h>)
#    include <LibWeb/CSS/HTMLTableElement.h>
#elif __has_include(<LibWeb/DOM/HTMLTableElement.h>)
#    include <LibWeb/DOM/HTMLTableElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLTableElement.h>)
#    include <LibWeb/Encoding/HTMLTableElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLTableElement.h>)
#    include <LibWeb/Geometry/HTMLTableElement.h>
#elif __has_include(<LibWeb/HTML/HTMLTableElement.h>)
#    include <LibWeb/HTML/HTMLTableElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLTableElement.h>)
#    include <LibWeb/UIEvents/HTMLTableElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLTableElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLTableElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLTableElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLTableElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLTableElement.h>)
#    include <LibWeb/NavigationTiming/HTMLTableElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLTableElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLTableElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLTableElement.h>)
#    include <LibWeb/ResizeObserver/HTMLTableElement.h>
#elif __has_include(<LibWeb/SVG/HTMLTableElement.h>)
#    include <LibWeb/SVG/HTMLTableElement.h>
#elif __has_include(<LibWeb/Selection/HTMLTableElement.h>)
#    include <LibWeb/Selection/HTMLTableElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLTableElement.h>)
#    include <LibWeb/WebSockets/HTMLTableElement.h>
#elif __has_include(<LibWeb/XHR/HTMLTableElement.h>)
#    include <LibWeb/XHR/HTMLTableElement.h>
#elif __has_include(<LibWeb/URL/HTMLTableElement.h>)
#    include <LibWeb/URL/HTMLTableElement.h>
#endif
...
HTMLTableElementConstructor::HTMLTableElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLTableElementConstructor::~HTMLTableElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLTableElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLTableElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLTableElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLTableElement");

}

void HTMLTableElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLTableElementPrototype>("HTMLTableElement"), 0);
