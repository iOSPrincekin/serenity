...
AttributePrototype::AttributePrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void AttributePrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("ownerElement", owner_element_getter, nullptr, default_attributes);

    define_native_accessor("specified", specified_getter, nullptr, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<DOM::Attribute*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<AttributeWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::Attribute");

    return &static_cast<AttributeWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::namespace_uri_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::prefix_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::local_name_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::name_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::value_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::value_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::owner_element_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->owner_element(); }));
...
JS_DEFINE_NATIVE_FUNCTION(AttributePrototype::specified_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->specified(); }));
