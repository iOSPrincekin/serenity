...
ShadowRootPrototype::ShadowRootPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<DocumentFragmentPrototype>("DocumentFragment"))
...
void ShadowRootPrototype::initialize(JS::GlobalObject& global_object)
{
    [[maybe_unused]] auto& vm = this->vm();
    [[maybe_unused]] u8 default_attributes = JS::Attribute::Enumerable | JS::Attribute::Configurable | JS::Attribute::Writable;


    define_native_accessor("mode", mode_getter, nullptr, default_attributes);
...
static JS::ThrowCompletionOr<DOM::ShadowRoot*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<ShadowRootWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::ShadowRoot");

    return &static_cast<ShadowRootWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(ShadowRootPrototype::mode_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->mode(); }));
