...
HTMLDataListElementPrototype::HTMLDataListElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLDataListElementPrototype::~HTMLDataListElementPrototype()
{
}

void HTMLDataListElementPrototype::initialize(JS::GlobalObject& global_object)
{
