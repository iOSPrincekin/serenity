...
#if __has_include(<LibWeb/Crypto/SVGCircleElement.h>)
#    include <LibWeb/Crypto/SVGCircleElement.h>
#elif __has_include(<LibWeb/CSS/SVGCircleElement.h>)
#    include <LibWeb/CSS/SVGCircleElement.h>
#elif __has_include(<LibWeb/DOM/SVGCircleElement.h>)
#    include <LibWeb/DOM/SVGCircleElement.h>
#elif __has_include(<LibWeb/Encoding/SVGCircleElement.h>)
#    include <LibWeb/Encoding/SVGCircleElement.h>
#elif __has_include(<LibWeb/Geometry/SVGCircleElement.h>)
#    include <LibWeb/Geometry/SVGCircleElement.h>
#elif __has_include(<LibWeb/HTML/SVGCircleElement.h>)
#    include <LibWeb/HTML/SVGCircleElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGCircleElement.h>)
#    include <LibWeb/UIEvents/SVGCircleElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGCircleElement.h>)
#    include <LibWeb/HighResolutionTime/SVGCircleElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGCircleElement.h>)
#    include <LibWeb/IntersectionObserver/SVGCircleElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGCircleElement.h>)
#    include <LibWeb/NavigationTiming/SVGCircleElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGCircleElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGCircleElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGCircleElement.h>)
#    include <LibWeb/ResizeObserver/SVGCircleElement.h>
#elif __has_include(<LibWeb/SVG/SVGCircleElement.h>)
#    include <LibWeb/SVG/SVGCircleElement.h>
#elif __has_include(<LibWeb/Selection/SVGCircleElement.h>)
#    include <LibWeb/Selection/SVGCircleElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGCircleElement.h>)
#    include <LibWeb/WebSockets/SVGCircleElement.h>
#elif __has_include(<LibWeb/XHR/SVGCircleElement.h>)
#    include <LibWeb/XHR/SVGCircleElement.h>
#elif __has_include(<LibWeb/URL/SVGCircleElement.h>)
#    include <LibWeb/URL/SVGCircleElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/SVGCircleElementWrapper.h>)
#   include <LibWeb/Bindings/SVGCircleElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/SVGCircleElementWrapperFactory.h>)
#   include <LibWeb/Bindings/SVGCircleElementWrapperFactory.h>
#endif
...
SVGCircleElementConstructor::SVGCircleElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGCircleElementConstructor::~SVGCircleElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGCircleElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGCircleElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGCircleElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGCircleElement");

}

void SVGCircleElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGCircleElementPrototype>("SVGCircleElement"), 0);
