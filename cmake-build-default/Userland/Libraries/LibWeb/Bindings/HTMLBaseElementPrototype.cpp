...
HTMLBaseElementPrototype::HTMLBaseElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLBaseElementPrototype::~HTMLBaseElementPrototype()
{
}

void HTMLBaseElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLBaseElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLBaseElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLBaseElement");

    return &static_cast<HTMLBaseElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLBaseElementPrototype::target_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLBaseElementPrototype::target_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
