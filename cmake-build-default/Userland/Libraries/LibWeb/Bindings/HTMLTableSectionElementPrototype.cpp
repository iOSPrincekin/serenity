...
HTMLTableSectionElementPrototype::HTMLTableSectionElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLTableSectionElementPrototype::~HTMLTableSectionElementPrototype()
{
}

void HTMLTableSectionElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLTableSectionElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLTableSectionElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLTableSectionElement");

    return &static_cast<HTMLTableSectionElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::align_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::ch_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::ch_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::ch_off_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::ch_off_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::v_align_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::v_align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::rows_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::insert_row)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::delete_row)
{
