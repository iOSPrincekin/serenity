...
HTMLPreElementPrototype::HTMLPreElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLPreElementPrototype::~HTMLPreElementPrototype()
{
}

void HTMLPreElementPrototype::initialize(JS::GlobalObject& global_object)
{
