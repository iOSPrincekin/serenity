...
StyleSheetPrototype::StyleSheetPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(*global_object.object_prototype())

{
}

StyleSheetPrototype::~StyleSheetPrototype()
{
}

void StyleSheetPrototype::initialize(JS::GlobalObject& global_object)
{
    [[maybe_unused]] auto& vm = this->vm();
    [[maybe_unused]] u8 default_attributes = JS::Attribute::Enumerable | JS::Attribute::Configurable | JS::Attribute::Writable;


    define_native_accessor("ownerNode", owner_node_getter, nullptr, default_attributes);
    ...
    define_native_accessor("title", title_getter, nullptr, default_attributes);
...
static JS::ThrowCompletionOr<CSS::StyleSheet*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<StyleSheetWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "CSS::StyleSheet");

    return &static_cast<StyleSheetWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::owner_node_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->owner_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::type_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::href_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::parent_style_sheet_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::title_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::disabled_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->disabled(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::disabled_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
    ...
    TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->set_disabled(cpp_value); }));
