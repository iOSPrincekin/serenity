...
HTMLTableRowElementPrototype::HTMLTableRowElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLTableRowElementPrototype::~HTMLTableRowElementPrototype()
{
}

void HTMLTableRowElementPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("rowIndex", row_index_getter, nullptr, default_attributes);

    define_native_accessor("sectionRowIndex", section_row_index_getter, nullptr, default_attributes);

    define_native_accessor("cells", cells_getter, nullptr, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<HTML::HTMLTableRowElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLTableRowElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLTableRowElement");

    return &static_cast<HTMLTableRowElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::align_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::ch_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::ch_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::ch_off_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::ch_off_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::v_align_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::v_align_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::bg_color_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::bg_color_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::row_index_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->row_index(); }));

    return JS::Value((i32)retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::section_row_index_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->section_row_index(); }));

    return JS::Value((i32)retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::cells_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->cells(); }));
