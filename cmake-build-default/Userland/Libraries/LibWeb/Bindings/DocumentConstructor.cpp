...
#if __has_include(<LibWeb/Crypto/Document.h>)
#    include <LibWeb/Crypto/Document.h>
#elif __has_include(<LibWeb/CSS/Document.h>)
#    include <LibWeb/CSS/Document.h>
#elif __has_include(<LibWeb/DOM/Document.h>)
#    include <LibWeb/DOM/Document.h>
#elif __has_include(<LibWeb/Encoding/Document.h>)
#    include <LibWeb/Encoding/Document.h>
#elif __has_include(<LibWeb/Geometry/Document.h>)
#    include <LibWeb/Geometry/Document.h>
#elif __has_include(<LibWeb/HTML/Document.h>)
#    include <LibWeb/HTML/Document.h>
#elif __has_include(<LibWeb/UIEvents/Document.h>)
#    include <LibWeb/UIEvents/Document.h>
#elif __has_include(<LibWeb/HighResolutionTime/Document.h>)
#    include <LibWeb/HighResolutionTime/Document.h>
#elif __has_include(<LibWeb/IntersectionObserver/Document.h>)
#    include <LibWeb/IntersectionObserver/Document.h>
#elif __has_include(<LibWeb/NavigationTiming/Document.h>)
#    include <LibWeb/NavigationTiming/Document.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Document.h>)
#    include <LibWeb/RequestIdleCallback/Document.h>
#elif __has_include(<LibWeb/ResizeObserver/Document.h>)
#    include <LibWeb/ResizeObserver/Document.h>
#elif __has_include(<LibWeb/SVG/Document.h>)
#    include <LibWeb/SVG/Document.h>
#elif __has_include(<LibWeb/Selection/Document.h>)
#    include <LibWeb/Selection/Document.h>
#elif __has_include(<LibWeb/WebSockets/Document.h>)
#    include <LibWeb/WebSockets/Document.h>
#elif __has_include(<LibWeb/XHR/Document.h>)
#    include <LibWeb/XHR/Document.h>
#elif __has_include(<LibWeb/URL/Document.h>)
#    include <LibWeb/URL/Document.h>
#endif
...
DocumentConstructor::DocumentConstructor(JS::GlobalObject& global_object)
...
JS::ThrowCompletionOr<JS::Value> DocumentConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Document");
}

JS::ThrowCompletionOr<JS::Object*> DocumentConstructor::construct(FunctionObject&)
{
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return DOM::Document::create_with_global_object(window); }));

    return wrap(global_object, *impl);

}

void DocumentConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    auto& window = static_cast<WindowObject&>(global_object);
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<DocumentPrototype>("Document"), 0);
