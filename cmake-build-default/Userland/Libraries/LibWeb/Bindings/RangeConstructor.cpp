...
#if __has_include(<LibWeb/Crypto/Range.h>)
#    include <LibWeb/Crypto/Range.h>
#elif __has_include(<LibWeb/CSS/Range.h>)
#    include <LibWeb/CSS/Range.h>
#elif __has_include(<LibWeb/DOM/Range.h>)
#    include <LibWeb/DOM/Range.h>
#elif __has_include(<LibWeb/Encoding/Range.h>)
#    include <LibWeb/Encoding/Range.h>
#elif __has_include(<LibWeb/Geometry/Range.h>)
#    include <LibWeb/Geometry/Range.h>
#elif __has_include(<LibWeb/HTML/Range.h>)
#    include <LibWeb/HTML/Range.h>
#elif __has_include(<LibWeb/UIEvents/Range.h>)
#    include <LibWeb/UIEvents/Range.h>
#elif __has_include(<LibWeb/HighResolutionTime/Range.h>)
#    include <LibWeb/HighResolutionTime/Range.h>
#elif __has_include(<LibWeb/IntersectionObserver/Range.h>)
#    include <LibWeb/IntersectionObserver/Range.h>
#elif __has_include(<LibWeb/NavigationTiming/Range.h>)
#    include <LibWeb/NavigationTiming/Range.h>
#elif __has_include(<LibWeb/RequestIdleCallback/Range.h>)
#    include <LibWeb/RequestIdleCallback/Range.h>
#elif __has_include(<LibWeb/ResizeObserver/Range.h>)
#    include <LibWeb/ResizeObserver/Range.h>
#elif __has_include(<LibWeb/SVG/Range.h>)
#    include <LibWeb/SVG/Range.h>
#elif __has_include(<LibWeb/Selection/Range.h>)
#    include <LibWeb/Selection/Range.h>
#elif __has_include(<LibWeb/WebSockets/Range.h>)
#    include <LibWeb/WebSockets/Range.h>
#elif __has_include(<LibWeb/XHR/Range.h>)
#    include <LibWeb/XHR/Range.h>
#elif __has_include(<LibWeb/URL/Range.h>)
#    include <LibWeb/URL/Range.h>
#endif
...
JS::ThrowCompletionOr<JS::Value> RangeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "Range");
}

JS::ThrowCompletionOr<JS::Object*> RangeConstructor::construct(FunctionObject&)
{
    ...
    auto impl = TRY(throw_dom_exception_if_needed(global_object, [&] { return DOM::Range::create_with_global_object(window); }));
...
void RangeConstructor::initialize(JS::GlobalObject& global_object)
{
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<RangePrototype>("Range"), 0);
