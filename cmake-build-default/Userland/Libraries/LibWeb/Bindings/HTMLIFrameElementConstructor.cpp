...
#if __has_include(<LibWeb/Crypto/HTMLIFrameElement.h>)
#    include <LibWeb/Crypto/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/CSS/HTMLIFrameElement.h>)
#    include <LibWeb/CSS/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/DOM/HTMLIFrameElement.h>)
#    include <LibWeb/DOM/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/Encoding/HTMLIFrameElement.h>)
#    include <LibWeb/Encoding/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/Geometry/HTMLIFrameElement.h>)
#    include <LibWeb/Geometry/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/HTML/HTMLIFrameElement.h>)
#    include <LibWeb/HTML/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/UIEvents/HTMLIFrameElement.h>)
#    include <LibWeb/UIEvents/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLIFrameElement.h>)
#    include <LibWeb/HighResolutionTime/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLIFrameElement.h>)
#    include <LibWeb/IntersectionObserver/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLIFrameElement.h>)
#    include <LibWeb/NavigationTiming/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLIFrameElement.h>)
#    include <LibWeb/RequestIdleCallback/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLIFrameElement.h>)
#    include <LibWeb/ResizeObserver/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/SVG/HTMLIFrameElement.h>)
#    include <LibWeb/SVG/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/Selection/HTMLIFrameElement.h>)
#    include <LibWeb/Selection/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/WebSockets/HTMLIFrameElement.h>)
#    include <LibWeb/WebSockets/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/XHR/HTMLIFrameElement.h>)
#    include <LibWeb/XHR/HTMLIFrameElement.h>
#elif __has_include(<LibWeb/URL/HTMLIFrameElement.h>)
#    include <LibWeb/URL/HTMLIFrameElement.h>
#endif
...
#if __has_include(<LibWeb/Bindings/HTMLIFrameElementWrapper.h>)
#   include <LibWeb/Bindings/HTMLIFrameElementWrapper.h>
#endif
#if __has_include(<LibWeb/Bindings/HTMLIFrameElementWrapperFactory.h>)
#   include <LibWeb/Bindings/HTMLIFrameElementWrapperFactory.h>
#endif
...
HTMLIFrameElementConstructor::HTMLIFrameElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLIFrameElementConstructor::~HTMLIFrameElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLIFrameElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLIFrameElement");
}

JS::ThrowCompletionOr<JS::Object*> HTMLIFrameElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLIFrameElement");

}

void HTMLIFrameElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLIFrameElementPrototype>("HTMLIFrameElement"), 0);
