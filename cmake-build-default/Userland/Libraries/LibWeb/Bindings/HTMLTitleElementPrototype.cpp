...
HTMLTitleElementPrototype::HTMLTitleElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLTitleElementPrototype::~HTMLTitleElementPrototype()
{
}

void HTMLTitleElementPrototype::initialize(JS::GlobalObject& global_object)
{
