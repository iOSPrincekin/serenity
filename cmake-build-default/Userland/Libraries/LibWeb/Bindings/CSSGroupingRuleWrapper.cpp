...
CSSGroupingRuleWrapper* CSSGroupingRuleWrapper::create(JS::GlobalObject& global_object, CSS::CSSGroupingRule& impl)
{
    return global_object.heap().allocate<CSSGroupingRuleWrapper>(global_object, global_object, impl);
}


CSSGroupingRuleWrapper::CSSGroupingRuleWrapper(JS::GlobalObject& global_object, CSS::CSSGroupingRule& impl)
    : CSSRuleWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<CSSGroupingRulePrototype>("CSSGroupingRule"));
}

void CSSGroupingRuleWrapper::initialize(JS::GlobalObject& global_object)
{
    CSSRuleWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "CSSGroupingRule"), JS::Attribute::Configurable);
}

CSSGroupingRuleWrapper::~CSSGroupingRuleWrapper()
{
}
