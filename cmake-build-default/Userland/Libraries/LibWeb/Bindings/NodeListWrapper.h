...
class NodeListWrapper : public Wrapper {
    JS_OBJECT(NodeList, Wrapper);
public:
    static NodeListWrapper* create(JS::GlobalObject&, DOM::NodeList&);

    NodeListWrapper(JS::GlobalObject&, DOM::NodeList&);
    virtual void initialize(JS::GlobalObject&) override;
    virtual ~NodeListWrapper() override;
    ...
    DOM::NodeList& impl() { return *m_impl; }
    DOM::NodeList const& impl() const { return *m_impl; }
...
private:
    ...
    NonnullRefPtr<DOM::NodeList> m_impl;
        
};

NodeListWrapper* wrap(JS::GlobalObject&, DOM::NodeList&);
