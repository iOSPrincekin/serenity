...
AttributeWrapper* AttributeWrapper::create(JS::GlobalObject& global_object, DOM::Attribute& impl)
{
    return global_object.heap().allocate<AttributeWrapper>(global_object, global_object, impl);
}


AttributeWrapper::AttributeWrapper(JS::GlobalObject& global_object, DOM::Attribute& impl)
    : NodeWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<AttributePrototype>("Attribute"));
}

void AttributeWrapper::initialize(JS::GlobalObject& global_object)
{
    NodeWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "Attribute"), JS::Attribute::Configurable);
}
...
AttributeWrapper* wrap(JS::GlobalObject& global_object, DOM::Attribute& impl)
{
    return static_cast<AttributeWrapper*>(wrap_impl(global_object, impl));
}
