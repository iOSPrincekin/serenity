...
ProcessingInstructionPrototype::ProcessingInstructionPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<CharacterDataPrototype>("CharacterData"))

{
}

ProcessingInstructionPrototype::~ProcessingInstructionPrototype()
{
}

void ProcessingInstructionPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<DOM::ProcessingInstruction*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<ProcessingInstructionWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "DOM::ProcessingInstruction");

    return &static_cast<ProcessingInstructionWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(ProcessingInstructionPrototype::target_getter)
{
