...
SVGGraphicsElementWrapper* SVGGraphicsElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGGraphicsElement& impl)
{
    return global_object.heap().allocate<SVGGraphicsElementWrapper>(global_object, global_object, impl);
}


SVGGraphicsElementWrapper::SVGGraphicsElementWrapper(JS::GlobalObject& global_object, SVG::SVGGraphicsElement& impl)
    : SVGElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGraphicsElementPrototype>("SVGGraphicsElement"));
}

void SVGGraphicsElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGGraphicsElement"), JS::Attribute::Configurable);
}

SVGGraphicsElementWrapper::~SVGGraphicsElementWrapper()
{
}
