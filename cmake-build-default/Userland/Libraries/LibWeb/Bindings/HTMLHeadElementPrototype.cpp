...
HTMLHeadElementPrototype::HTMLHeadElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLHeadElementPrototype::~HTMLHeadElementPrototype()
{
}

void HTMLHeadElementPrototype::initialize(JS::GlobalObject& global_object)
{
