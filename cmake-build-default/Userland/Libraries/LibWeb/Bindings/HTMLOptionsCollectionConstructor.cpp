...
#if __has_include(<LibWeb/Crypto/HTMLOptionsCollection.h>)
#    include <LibWeb/Crypto/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/CSS/HTMLOptionsCollection.h>)
#    include <LibWeb/CSS/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/DOM/HTMLOptionsCollection.h>)
#    include <LibWeb/DOM/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/Encoding/HTMLOptionsCollection.h>)
#    include <LibWeb/Encoding/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/Geometry/HTMLOptionsCollection.h>)
#    include <LibWeb/Geometry/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/HTML/HTMLOptionsCollection.h>)
#    include <LibWeb/HTML/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/UIEvents/HTMLOptionsCollection.h>)
#    include <LibWeb/UIEvents/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/HighResolutionTime/HTMLOptionsCollection.h>)
#    include <LibWeb/HighResolutionTime/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/IntersectionObserver/HTMLOptionsCollection.h>)
#    include <LibWeb/IntersectionObserver/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/NavigationTiming/HTMLOptionsCollection.h>)
#    include <LibWeb/NavigationTiming/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/RequestIdleCallback/HTMLOptionsCollection.h>)
#    include <LibWeb/RequestIdleCallback/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/ResizeObserver/HTMLOptionsCollection.h>)
#    include <LibWeb/ResizeObserver/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/SVG/HTMLOptionsCollection.h>)
#    include <LibWeb/SVG/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/Selection/HTMLOptionsCollection.h>)
#    include <LibWeb/Selection/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/WebSockets/HTMLOptionsCollection.h>)
#    include <LibWeb/WebSockets/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/XHR/HTMLOptionsCollection.h>)
#    include <LibWeb/XHR/HTMLOptionsCollection.h>
#elif __has_include(<LibWeb/URL/HTMLOptionsCollection.h>)
#    include <LibWeb/URL/HTMLOptionsCollection.h>
#endif
...
HTMLOptionsCollectionConstructor::HTMLOptionsCollectionConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

HTMLOptionsCollectionConstructor::~HTMLOptionsCollectionConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLOptionsCollectionConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "HTMLOptionsCollection");
}

JS::ThrowCompletionOr<JS::Object*> HTMLOptionsCollectionConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "HTMLOptionsCollection");

}

void HTMLOptionsCollectionConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<HTMLOptionsCollectionPrototype>("HTMLOptionsCollection"), 0);
