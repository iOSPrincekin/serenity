...
CSSConditionRuleWrapper* CSSConditionRuleWrapper::create(JS::GlobalObject& global_object, CSS::CSSConditionRule& impl)
{
    return global_object.heap().allocate<CSSConditionRuleWrapper>(global_object, global_object, impl);
}


CSSConditionRuleWrapper::CSSConditionRuleWrapper(JS::GlobalObject& global_object, CSS::CSSConditionRule& impl)
    : CSSGroupingRuleWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<CSSConditionRulePrototype>("CSSConditionRule"));
}

void CSSConditionRuleWrapper::initialize(JS::GlobalObject& global_object)
{
    CSSGroupingRuleWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "CSSConditionRule"), JS::Attribute::Configurable);
}

CSSConditionRuleWrapper::~CSSConditionRuleWrapper()
{
}
