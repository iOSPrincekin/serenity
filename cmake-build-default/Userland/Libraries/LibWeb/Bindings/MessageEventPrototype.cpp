...
MessageEventPrototype::MessageEventPrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void MessageEventPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("lastEventId", last_event_id_getter, nullptr, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<HTML::MessageEvent*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<MessageEventWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::MessageEvent");

    return &static_cast<MessageEventWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(MessageEventPrototype::last_event_id_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->last_event_id(); }));
