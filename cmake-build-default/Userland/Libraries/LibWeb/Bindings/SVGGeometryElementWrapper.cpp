...
SVGGeometryElementWrapper* SVGGeometryElementWrapper::create(JS::GlobalObject& global_object, SVG::SVGGeometryElement& impl)
{
    return global_object.heap().allocate<SVGGeometryElementWrapper>(global_object, global_object, impl);
}


SVGGeometryElementWrapper::SVGGeometryElementWrapper(JS::GlobalObject& global_object, SVG::SVGGeometryElement& impl)
    : SVGGraphicsElementWrapper(global_object, impl)
{
    set_prototype(&static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"));
}

void SVGGeometryElementWrapper::initialize(JS::GlobalObject& global_object)
{
    SVGGraphicsElementWrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "SVGGeometryElement"), JS::Attribute::Configurable);
}

SVGGeometryElementWrapper::~SVGGeometryElementWrapper()
{
}
