...
NamedNodeMapWrapper* NamedNodeMapWrapper::create(JS::GlobalObject& global_object, DOM::NamedNodeMap& impl)
{
    return global_object.heap().allocate<NamedNodeMapWrapper>(global_object, global_object, impl);
}


NamedNodeMapWrapper::NamedNodeMapWrapper(JS::GlobalObject& global_object, DOM::NamedNodeMap& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<NamedNodeMapPrototype>("NamedNodeMap"))
    , m_impl(impl)
{
}

void NamedNodeMapWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "NamedNodeMap"), JS::Attribute::Configurable);
}

NamedNodeMapWrapper::~NamedNodeMapWrapper()
{
}

NamedNodeMapWrapper* wrap(JS::GlobalObject& global_object, DOM::NamedNodeMap& impl)
{
    return static_cast<NamedNodeMapWrapper*>(wrap_impl(global_object, impl));
}
...
static JS::Value wrap_for_legacy_platform_object_get_own_property(JS::GlobalObject& global_object, [[maybe_unused]] auto& retval)
{
    ...
    return wrap(global_object, const_cast<Attribute&>(*retval));

    }

}

JS::ThrowCompletionOr<bool> NamedNodeMapWrapper::is_named_property_exposed_on_object(JS::PropertyKey const& property_key) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> NamedNodeMapWrapper::legacy_platform_object_get_own_property_for_get_own_property_slot(JS::PropertyKey const& property_name) const
{
    ...
    if (TRY(is_named_property_exposed_on_object(property_name))) {
        ...
        auto value = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl().get_named_item(property_name_string); }));
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> NamedNodeMapWrapper::legacy_platform_object_get_own_property_for_set_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> NamedNodeMapWrapper::internal_get_own_property(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<bool> NamedNodeMapWrapper::internal_set(JS::PropertyKey const& property_name, JS::Value value, JS::Value receiver)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> NamedNodeMapWrapper::internal_define_own_property(JS::PropertyKey const& property_name, JS::PropertyDescriptor const& property_descriptor)
{
    [[maybe_unused]] auto& vm = this->vm();
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> NamedNodeMapWrapper::internal_delete(JS::PropertyKey const& property_name)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> NamedNodeMapWrapper::internal_prevent_extensions()
{
    // 1. Return false.
    return false;
}

JS::ThrowCompletionOr<JS::MarkedVector<JS::Value>> NamedNodeMapWrapper::internal_own_property_keys() const
{
    auto& vm = this->vm();
