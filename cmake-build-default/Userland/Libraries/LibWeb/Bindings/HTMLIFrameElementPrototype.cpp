...
HTMLIFrameElementPrototype::HTMLIFrameElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
...
void HTMLIFrameElementPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("srcdoc", srcdoc_getter, srcdoc_setter, default_attributes);

    define_native_accessor("name", name_getter, name_setter, default_attributes);

    define_native_accessor("allow", allow_getter, allow_setter, default_attributes);
    ...
    define_native_accessor("allowFullscreen", allow_fullscreen_getter, allow_fullscreen_setter, default_attributes);
    ...
    define_native_accessor("marginHeight", margin_height_getter, margin_height_setter, default_attributes);

    define_native_accessor("marginWidth", margin_width_getter, margin_width_setter, default_attributes);
...
static JS::ThrowCompletionOr<HTML::HTMLIFrameElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLIFrameElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLIFrameElement");

    return &static_cast<HTMLIFrameElementWrapper*>(this_object)->impl();
}
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::srcdoc_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::srcdoc);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::srcdoc_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::srcdoc, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::allow_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::allow);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::allow_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::allow, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::allow_fullscreen_getter)
{
    ...
    auto retval = impl->has_attribute(HTML::AttributeNames::allowfullscreen);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::allow_fullscreen_setter)
{
    ...
    if (!cpp_value)
        impl->remove_attribute(HTML::AttributeNames::allowfullscreen);
    else
        impl->set_attribute(HTML::AttributeNames::allowfullscreen, String::empty());
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::margin_height_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::marginheight);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::margin_height_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::marginheight, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::margin_width_getter)
{
    ...
    auto retval = impl->attribute(HTML::AttributeNames::marginwidth);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLIFrameElementPrototype::margin_width_setter)
{
    ...
    impl->set_attribute(HTML::AttributeNames::marginwidth, cpp_value);
