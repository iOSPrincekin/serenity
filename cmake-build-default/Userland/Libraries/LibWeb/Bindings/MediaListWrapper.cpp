...
MediaListWrapper* MediaListWrapper::create(JS::GlobalObject& global_object, CSS::MediaList& impl)
{
    return global_object.heap().allocate<MediaListWrapper>(global_object, global_object, impl);
}


MediaListWrapper::MediaListWrapper(JS::GlobalObject& global_object, CSS::MediaList& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<MediaListPrototype>("MediaList"))
    , m_impl(impl)
{
}

void MediaListWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "MediaList"), JS::Attribute::Configurable);
}
...
MediaListWrapper* wrap(JS::GlobalObject& global_object, CSS::MediaList& impl)
{
    return static_cast<MediaListWrapper*>(wrap_impl(global_object, impl));
}
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> MediaListWrapper::legacy_platform_object_get_own_property_for_get_own_property_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> MediaListWrapper::legacy_platform_object_get_own_property_for_set_slot(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> MediaListWrapper::internal_get_own_property(JS::PropertyKey const& property_name) const
{
...
JS::ThrowCompletionOr<bool> MediaListWrapper::internal_set(JS::PropertyKey const& property_name, JS::Value value, JS::Value receiver)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> MediaListWrapper::internal_define_own_property(JS::PropertyKey const& property_name, JS::PropertyDescriptor const& property_descriptor)
{
...
JS::ThrowCompletionOr<bool> MediaListWrapper::internal_delete(JS::PropertyKey const& property_name)
{
    [[maybe_unused]] auto& global_object = this->global_object();
...
JS::ThrowCompletionOr<bool> MediaListWrapper::internal_prevent_extensions()
{
    // 1. Return false.
    return false;
}

JS::ThrowCompletionOr<JS::MarkedVector<JS::Value>> MediaListWrapper::internal_own_property_keys() const
{
    auto& vm = this->vm();
