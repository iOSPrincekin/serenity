...
#if __has_include(<LibWeb/Crypto/StyleSheet.h>)
#    include <LibWeb/Crypto/StyleSheet.h>
#elif __has_include(<LibWeb/CSS/StyleSheet.h>)
#    include <LibWeb/CSS/StyleSheet.h>
#elif __has_include(<LibWeb/DOM/StyleSheet.h>)
#    include <LibWeb/DOM/StyleSheet.h>
#elif __has_include(<LibWeb/Encoding/StyleSheet.h>)
#    include <LibWeb/Encoding/StyleSheet.h>
#elif __has_include(<LibWeb/Geometry/StyleSheet.h>)
#    include <LibWeb/Geometry/StyleSheet.h>
#elif __has_include(<LibWeb/HTML/StyleSheet.h>)
#    include <LibWeb/HTML/StyleSheet.h>
#elif __has_include(<LibWeb/UIEvents/StyleSheet.h>)
#    include <LibWeb/UIEvents/StyleSheet.h>
#elif __has_include(<LibWeb/HighResolutionTime/StyleSheet.h>)
#    include <LibWeb/HighResolutionTime/StyleSheet.h>
#elif __has_include(<LibWeb/IntersectionObserver/StyleSheet.h>)
#    include <LibWeb/IntersectionObserver/StyleSheet.h>
#elif __has_include(<LibWeb/NavigationTiming/StyleSheet.h>)
#    include <LibWeb/NavigationTiming/StyleSheet.h>
#elif __has_include(<LibWeb/RequestIdleCallback/StyleSheet.h>)
#    include <LibWeb/RequestIdleCallback/StyleSheet.h>
#elif __has_include(<LibWeb/ResizeObserver/StyleSheet.h>)
#    include <LibWeb/ResizeObserver/StyleSheet.h>
#elif __has_include(<LibWeb/SVG/StyleSheet.h>)
#    include <LibWeb/SVG/StyleSheet.h>
#elif __has_include(<LibWeb/Selection/StyleSheet.h>)
#    include <LibWeb/Selection/StyleSheet.h>
#elif __has_include(<LibWeb/WebSockets/StyleSheet.h>)
#    include <LibWeb/WebSockets/StyleSheet.h>
#elif __has_include(<LibWeb/XHR/StyleSheet.h>)
#    include <LibWeb/XHR/StyleSheet.h>
#elif __has_include(<LibWeb/URL/StyleSheet.h>)
#    include <LibWeb/URL/StyleSheet.h>
#endif
...
StyleSheetConstructor::StyleSheetConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

StyleSheetConstructor::~StyleSheetConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> StyleSheetConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "StyleSheet");
}

JS::ThrowCompletionOr<JS::Object*> StyleSheetConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "StyleSheet");

}

void StyleSheetConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<StyleSheetPrototype>("StyleSheet"), 0);
