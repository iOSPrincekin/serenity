...
HTMLFormElementPrototype::HTMLFormElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLFormElementPrototype::~HTMLFormElementPrototype()
{
}

void HTMLFormElementPrototype::initialize(JS::GlobalObject& global_object)
{
    ...
    define_native_accessor("acceptCharset", accept_charset_getter, accept_charset_setter, default_attributes);

    define_native_accessor("noValidate", no_validate_getter, no_validate_setter, default_attributes);

    define_native_accessor("elements", elements_getter, nullptr, default_attributes);

    define_native_accessor("length", length_getter, nullptr, default_attributes);

    define_native_function("submit", submit, 0, default_attributes);

    Object::initialize(global_object);
}

static JS::ThrowCompletionOr<HTML::HTMLFormElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLFormElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLFormElement");

    return &static_cast<HTMLFormElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::name_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::name_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::rel_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::rel_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::accept_charset_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = impl->attribute(HTML::AttributeNames::accept_charset);

    return JS::js_string(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::accept_charset_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
    ...
    impl->set_attribute(HTML::AttributeNames::accept_charset, cpp_value);

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::no_validate_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = impl->has_attribute(HTML::AttributeNames::novalidate);

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::no_validate_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
    ...
    if (!cpp_value)
        impl->remove_attribute(HTML::AttributeNames::novalidate);
    else
        impl->set_attribute(HTML::AttributeNames::novalidate, String::empty());

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::elements_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));

    auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->elements(); }));

    return wrap(global_object, const_cast<HTMLCollection&>(*retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::length_getter)
{
    auto* impl = TRY(impl_from(vm, global_object));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFormElementPrototype::submit)
{

    auto* impl = TRY(impl_from(vm, global_object));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(global_object, [&] { return impl->submit(); }));
