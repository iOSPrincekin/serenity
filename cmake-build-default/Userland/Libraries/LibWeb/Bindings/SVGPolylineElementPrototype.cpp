...
SVGPolylineElementPrototype::SVGPolylineElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"))

{
}

SVGPolylineElementPrototype::~SVGPolylineElementPrototype()
{
}

void SVGPolylineElementPrototype::initialize(JS::GlobalObject& global_object)
{
