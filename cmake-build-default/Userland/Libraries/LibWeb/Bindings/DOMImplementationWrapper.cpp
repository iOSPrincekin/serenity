...
DOMImplementationWrapper* DOMImplementationWrapper::create(JS::GlobalObject& global_object, DOM::DOMImplementation& impl)
{
    return global_object.heap().allocate<DOMImplementationWrapper>(global_object, global_object, impl);
}


DOMImplementationWrapper::DOMImplementationWrapper(JS::GlobalObject& global_object, DOM::DOMImplementation& impl)
    : Wrapper(static_cast<WindowObject&>(global_object).ensure_web_prototype<DOMImplementationPrototype>("DOMImplementation"))
    , m_impl(impl)
{
}

void DOMImplementationWrapper::initialize(JS::GlobalObject& global_object)
{
    Wrapper::initialize(global_object);

    auto& vm = global_object.vm();
    define_direct_property(*vm.well_known_symbol_to_string_tag(), JS::js_string(vm, "DOMImplementation"), JS::Attribute::Configurable);
}

DOMImplementationWrapper::~DOMImplementationWrapper()
{
}

DOMImplementationWrapper* wrap(JS::GlobalObject& global_object, DOM::DOMImplementation& impl)
{
    return static_cast<DOMImplementationWrapper*>(wrap_impl(global_object, impl));
}
