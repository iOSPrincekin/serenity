...
#if __has_include(<LibWeb/Crypto/SVGGeometryElement.h>)
#    include <LibWeb/Crypto/SVGGeometryElement.h>
#elif __has_include(<LibWeb/CSS/SVGGeometryElement.h>)
#    include <LibWeb/CSS/SVGGeometryElement.h>
#elif __has_include(<LibWeb/DOM/SVGGeometryElement.h>)
#    include <LibWeb/DOM/SVGGeometryElement.h>
#elif __has_include(<LibWeb/Encoding/SVGGeometryElement.h>)
#    include <LibWeb/Encoding/SVGGeometryElement.h>
#elif __has_include(<LibWeb/Geometry/SVGGeometryElement.h>)
#    include <LibWeb/Geometry/SVGGeometryElement.h>
#elif __has_include(<LibWeb/HTML/SVGGeometryElement.h>)
#    include <LibWeb/HTML/SVGGeometryElement.h>
#elif __has_include(<LibWeb/UIEvents/SVGGeometryElement.h>)
#    include <LibWeb/UIEvents/SVGGeometryElement.h>
#elif __has_include(<LibWeb/HighResolutionTime/SVGGeometryElement.h>)
#    include <LibWeb/HighResolutionTime/SVGGeometryElement.h>
#elif __has_include(<LibWeb/IntersectionObserver/SVGGeometryElement.h>)
#    include <LibWeb/IntersectionObserver/SVGGeometryElement.h>
#elif __has_include(<LibWeb/NavigationTiming/SVGGeometryElement.h>)
#    include <LibWeb/NavigationTiming/SVGGeometryElement.h>
#elif __has_include(<LibWeb/RequestIdleCallback/SVGGeometryElement.h>)
#    include <LibWeb/RequestIdleCallback/SVGGeometryElement.h>
#elif __has_include(<LibWeb/ResizeObserver/SVGGeometryElement.h>)
#    include <LibWeb/ResizeObserver/SVGGeometryElement.h>
#elif __has_include(<LibWeb/SVG/SVGGeometryElement.h>)
#    include <LibWeb/SVG/SVGGeometryElement.h>
#elif __has_include(<LibWeb/Selection/SVGGeometryElement.h>)
#    include <LibWeb/Selection/SVGGeometryElement.h>
#elif __has_include(<LibWeb/WebSockets/SVGGeometryElement.h>)
#    include <LibWeb/WebSockets/SVGGeometryElement.h>
#elif __has_include(<LibWeb/XHR/SVGGeometryElement.h>)
#    include <LibWeb/XHR/SVGGeometryElement.h>
#elif __has_include(<LibWeb/URL/SVGGeometryElement.h>)
#    include <LibWeb/URL/SVGGeometryElement.h>
#endif
...
SVGGeometryElementConstructor::SVGGeometryElementConstructor(JS::GlobalObject& global_object)
    : NativeFunction(*global_object.function_prototype())
{
}

SVGGeometryElementConstructor::~SVGGeometryElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGGeometryElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::ConstructorWithoutNew, "SVGGeometryElement");
}

JS::ThrowCompletionOr<JS::Object*> SVGGeometryElementConstructor::construct(FunctionObject&)
{

    return vm().throw_completion<JS::TypeError>(global_object(), JS::ErrorType::NotAConstructor, "SVGGeometryElement");

}

void SVGGeometryElementConstructor::initialize(JS::GlobalObject& global_object)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.prototype, &window.ensure_web_prototype<SVGGeometryElementPrototype>("SVGGeometryElement"), 0);
