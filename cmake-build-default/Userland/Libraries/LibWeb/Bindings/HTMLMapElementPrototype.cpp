...
HTMLMapElementPrototype::HTMLMapElementPrototype([[maybe_unused]] JS::GlobalObject& global_object)
    : Object(static_cast<WindowObject&>(global_object).ensure_web_prototype<HTMLElementPrototype>("HTMLElement"))

{
}

HTMLMapElementPrototype::~HTMLMapElementPrototype()
{
}

void HTMLMapElementPrototype::initialize(JS::GlobalObject& global_object)
{
...
static JS::ThrowCompletionOr<HTML::HTMLMapElement*> impl_from(JS::VM& vm, JS::GlobalObject& global_object)
{
    ...
    if (!is<HTMLMapElementWrapper>(this_object))
        return vm.throw_completion<JS::TypeError>(global_object, JS::ErrorType::NotAnObjectOfType, "HTML::HTMLMapElement");

    return &static_cast<HTMLMapElementWrapper*>(this_object)->impl();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLMapElementPrototype::name_getter)
{
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMapElementPrototype::name_setter)
{
    auto* impl = TRY(impl_from(vm, global_object));
